...
DEFINES += -DSN_TARGET_PS3 -DNDEBUG -DNO_ASMCORE -DNO_COMBO -DNO_AUTOFIRE -DNO_CHEATSEARCH -DTIXML_USE_TICPP -DWORDS_BIGENDIAN -DUSE_SPEEDHACKS -DPSGL -DNO_PNG -DOLD_AUDIOCORE=0 -DNO_CHEATS -DUSE_BPP_RENDERING=32 -DNO_SPRITE_ENABLE_TOGGLE
