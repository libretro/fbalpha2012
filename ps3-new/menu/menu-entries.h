/******************************************************************************* 
 * menu-entries.h - FBA Next Slim PS3
 *
...
static item items_generalsettings[MAX_NO_OF_CONTROLS_SETTINGS] =
{
	...
	},
	{
		...
		0.0f,
		YELLOW,
		"INFO - Set [all FBA settings] back to their 'DEFAULT' values.",
		GREEN,
		0.91f,
		0.09f,
		0.83f,
	...
	},
	{
		...
		0.0f,
		YELLOW,
		"INFO - Set [all FBA Video settings] back to their 'DEFAULT' values.",
		GREEN,
		0.91f,
		0.09f,
		0.83f,
	...
	},
	{
		...
		0.0f,
		YELLOW,
		"INFO - Set [all FBA Audio settings] back to their 'DEFAULT' values.",
		GREEN,
		0.91f,
		0.09f,
		0.83f,
