...
/* emulator-specific */
#define SCREEN_RENDER_TEXTURE_WIDTH  320
#define SCREEN_RENDER_TEXTURE_HEIGHT 240
#define SCREEN_RENDER_BYTE_BY_PIXEL  2
#define SCREEN_RENDER_PIXEL_FORMAT GL_RGB5_A1

#define SCREEN_RENDER_TEXTURE_PITCH (SCREEN_RENDER_TEXTURE_WIDTH * SCREEN_RENDER_BYTE_BY_PIXEL)

#define SCREEN_RENDER_TEXTURE_BITDEPTH		16
#define SCREEN_RENDER_TEXTURE_BPP		2
