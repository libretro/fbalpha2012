...
struct BurnDriver BurnDrvHcastle = {
	...
	NULL, NULL, hcastleRomInfo, hcastleRomName, NULL, NULL, HcastleInputInfo, HcastleDIPInfo,
...
struct BurnDriver BurnDrvHcastleo = {
	...
	NULL, NULL, hcastleoRomInfo, hcastleoRomName, NULL, NULL, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHcastlej = {
	...
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	NULL, NULL, hcastlejRomInfo, hcastlejRomName, NULL, NULL, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHcastljo = {
	...
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	NULL, NULL, hcastljoRomInfo, hcastljoRomName, NULL, NULL, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
