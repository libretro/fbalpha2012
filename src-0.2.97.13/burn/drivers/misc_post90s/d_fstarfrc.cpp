...
struct BurnDriver BurnDrvFstarfrc = {
	...
	NULL, NULL, FstarfrcRomInfo, FstarfrcRomName, NULL, NULL, FstarfrcInputInfo, FstarfrcDIPInfo,
...
struct BurnDriver BurnDrvFstarfrcj = {
	...
	NULL, NULL, FstarfrcjRomInfo, FstarfrcjRomName, NULL, NULL, FstarfrcInputInfo, FstarfrcDIPInfo,
	FstarfrcInit, FstarfrcExit, FstarfrcFrame, NULL, FstarfrcScan,
	NULL, 0x2000, 224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGinkun = {
	...
	NULL, NULL, GinkunRomInfo, GinkunRomName, NULL, NULL, FstarfrcInputInfo, GinkunDIPInfo,
	FstarfrcInit, FstarfrcExit, FstarfrcFrame, NULL, FstarfrcScan,
...
struct BurnDriver BurnDrvRiot = {
	...
	NULL, NULL, RiotRomInfo, RiotRomName, NULL, NULL, RiotInputInfo, RiotDIPInfo,
	FstarfrcInit, FstarfrcExit, FstarfrcFrame, NULL, FstarfrcScan,
	NULL, 0x2000, 256, 224, 4, 3
};
