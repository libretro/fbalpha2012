...
struct BurnDriver BurnDrvVmetal = {
	...
	NULL, NULL, vmetalRomInfo, vmetalRomName, NULL, NULL, vmetalInputInfo, vmetalDIPInfo,
...
struct BurnDriver BurnDrvVmetaln = {
	...
	NULL, NULL, vmetalnRomInfo, vmetalnRomName, NULL, NULL, vmetalInputInfo, vmetalDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 320, 3, 4
};
