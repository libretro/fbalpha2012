...
{
	unsigned int cycles = (nCyclesTotal[2] * (nCyclesDone[0]+VezCurrentCPU->reg.nec_ICount)) / (nCyclesTotal[0] / nInterleave);
...
static int DrvFrame()
{
	...
	for (int i = 0; i < nInterleave; i++)
	{
		...
		if (i == (nInterleave-1)) VezSetIRQLine(0xc8, VEZ_IRQSTATUS_ACK);
		VezClose();
...
struct BurnDriver BurnDrvDynduke = {
	...
	NULL, NULL, dyndukeRomInfo, dyndukeRomName, NULL, NULL, DyndukeInputInfo, DyndukeDIPInfo,
...
struct BurnDriver BurnDrvDyndukef = {
	...
	NULL, NULL, dyndukefRomInfo, dyndukefRomName, NULL, NULL, DyndukeInputInfo, DyndukeDIPInfo,
	dyndukeInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvDbldyn = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	NULL, NULL, dbldynRomInfo, dbldynRomName, NULL, NULL, DyndukeInputInfo, DyndukeDIPInfo,
...
struct BurnDriver BurnDrvDbldynf = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	NULL, NULL, dbldynfRomInfo, dbldynfRomName, NULL, NULL, DyndukeInputInfo, DyndukeDIPInfo,
	dyndukeInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
