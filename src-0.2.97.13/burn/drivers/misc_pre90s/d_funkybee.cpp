...
struct BurnDriver BurnDrvfunkybee = {
	...
	NULL, NULL, funkybeeRomInfo, funkybeeRomName, NULL, NULL, DrvInputInfo, funkybeeDIPInfo,
...
struct BurnDriver BurnDrvfunkbeeb = {
	...
	NULL, NULL, funkbeebRomInfo, funkbeebRomName, NULL, NULL, DrvInputInfo, funkbeebDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPal, 0x20,
	224, 232, 3, 4
};
...
struct BurnDriver BurnDrvskylancr = {
	...
	NULL, NULL, skylancrRomInfo, skylancrRomName, NULL, NULL, DrvInputInfo, skylancrDIPInfo,
...
struct BurnDriver BurnDrvskylance = {
	...
	NULL, NULL, skylanceRomInfo, skylanceRomName, NULL, NULL, DrvInputInfo, skylanceDIPInfo,
	skylancrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPal, 0x20,
	224, 232, 3, 4
};
