...
struct BurnDriver BurnDrvGalagao = {
	...
	NULL, NULL, GalagaoRomInfo, GalagaoRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 576, 224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalagamw = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	NULL, NULL, GalagamwRomInfo, GalagamwRomName, NULL, NULL, DrvInputInfo, GalagamwDIPInfo,
	DrvInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 576, 224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalagamk = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	NULL, NULL, GalagamkRomInfo, GalagamkRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 576, 224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalagamf = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	NULL, NULL, GalagamfRomInfo, GalagamfRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 576, 224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGallag = {
	...
	NULL, NULL, GallagRomInfo, GallagRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
