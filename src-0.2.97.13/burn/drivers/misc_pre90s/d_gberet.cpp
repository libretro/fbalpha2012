...
struct BurnDriver BurnDrvGberet = {
	...
	NULL, NULL, gberetRomInfo, gberetRomName, NULL, NULL, DrvInputInfo, gberetDIPInfo,
...
struct BurnDriver BurnDrvRushatck = {
	...
	NULL, NULL, rushatckRomInfo, rushatckRomName, NULL, NULL, DrvInputInfo, gberetDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPal, 0x200,
	240, 224, 4, 3
};
...
struct BurnDriver BurnDrvGberetb = {
	...
	NULL, NULL, gberetbRomInfo, gberetbRomName, NULL, NULL, gberetbInputInfo, gberetbDIPInfo,
...
struct BurnDriver BurnDrvMrgoemon = {
	...
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	NULL, NULL, mrgoemonRomInfo, mrgoemonRomName, NULL, NULL, DrvInputInfo, mrgoemonDIPInfo,
