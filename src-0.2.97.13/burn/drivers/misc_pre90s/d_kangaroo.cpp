...
struct BurnDriver BurnDrvfnkyfish = {
	...
	NULL, NULL, fnkyfishRomInfo, fnkyfishRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvkangaroo = {
	...
	NULL, NULL, kangarooRomInfo, kangarooRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 
	&DrvRecalc, 0x08, 256, 512, 3, 4
};
...
struct BurnDriver BurnDrvkangaroa = {
	...
	NULL, NULL, kangaroaRomInfo, kangaroaRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 
	&DrvRecalc, 0x08, 256, 512, 3, 4
};
...
struct BurnDriver BurnDrvkangarob = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	NULL, NULL, kangarobRomInfo, kangarobRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL, 
	&DrvRecalc, 0x08, 256, 512, 3, 4
};
