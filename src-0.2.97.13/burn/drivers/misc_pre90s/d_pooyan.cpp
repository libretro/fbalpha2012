...
struct BurnDriver BurnDrvPooyan = {
	...
	NULL, NULL, pooyanRomInfo, pooyanRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvPooyans = {
	...
	NULL, NULL, pooyansRomInfo, pooyansRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPalette, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPootan = {
	...
	NULL, NULL, pootanRomInfo, pootanRomName, NULL, NULL, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPalette, 0x200,
	224, 256, 3, 4
};
