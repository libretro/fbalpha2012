...
struct BurnDriver BurnDrvOthunder = {
	...
	NULL, NULL, OthunderRomInfo, OthunderRomName, NULL, NULL, OthunderInputInfo, OthunderDIPInfo,
...
struct BurnDriver BurnDrvOthunderu = {
	...
	NULL, NULL, OthunderuRomInfo, OthunderuRomName, NULL, NULL, OthunderInputInfo, OthunderuDIPInfo,
	OthunderInit, OthunderExit, OthunderFrame, NULL, OthunderScan,
	NULL, 0x1000, 320, 240, 4, 3
};
...
struct BurnDriver BurnDrvOthunderuo = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_SHOOT, 0,
	NULL, NULL, OthunderuoRomInfo, OthunderuoRomName, NULL, NULL, OthunderInputInfo, OthunderuDIPInfo,
	OthunderInit, OthunderExit, OthunderFrame, NULL, OthunderScan,
	NULL, 0x1000, 320, 240, 4, 3
};
...
struct BurnDriver BurnDrvOthunderj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC, GBF_SHOOT, 0,
	NULL, NULL, OthunderjRomInfo, OthunderjRomName, NULL, NULL, OthunderInputInfo, OthunderjDIPInfo,
	OthunderInit, OthunderExit, OthunderFrame, NULL, OthunderScan,
	NULL, 0x1000, 320, 240, 4, 3
};
