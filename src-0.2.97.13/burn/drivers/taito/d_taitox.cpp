...
struct BurnDriver BurnDrvBallbros = {
	...
	NULL, NULL, BallbrosRomInfo, BallbrosRomName, NULL, NULL, TwinhawkInputInfo, BallbrosDIPInfo,
...
struct BurnDriver BurnDrvGigandes = {
	...
	NULL, NULL, GigandesRomInfo, GigandesRomName, NULL, NULL, TwinhawkInputInfo, GigandesDIPInfo,
...
struct BurnDriver BurnDrvGigandesj = {
	...
	NULL, NULL, GigandesjRomInfo, GigandesjRomName, NULL, NULL, TwinhawkInputInfo, GigandesDIPInfo,
	GigandesInit, TaitoXExit, TaitoXFrame, NULL, TaitoXScan,
	NULL, 0x800, 384, 240, 4, 3
};
...
struct BurnDriver BurnDrvKyustrkr = {
	...
	NULL, NULL, KyustrkrRomInfo, KyustrkrRomName, NULL, NULL, TwinhawkInputInfo, KyustrkrDIPInfo,
	BallbrosInit, TaitoXExit, TaitoXFrame, NULL, TaitoXScan,
	NULL, 0x800, 384, 240, 4, 3
};
...
struct BurnDriver BurnDrvSuperman = {
	...
	NULL, NULL, SupermanRomInfo, SupermanRomName, NULL, NULL, SupermanInputInfo, SupermanDIPInfo,
...
struct BurnDriver BurnDrvSupermanj = {
	...
	NULL, NULL, SupermanjRomInfo, SupermanjRomName, NULL, NULL, SupermanInputInfo, SupermanjDIPInfo,
	SupermanInit, TaitoXExit, TaitoXFrame, NULL, TaitoXScan,
	NULL, 0x800, 384, 240, 4, 3
};
...
struct BurnDriver BurnDrvTwinhawk = {
	...
	NULL, NULL, TwinhawkRomInfo, TwinhawkRomName, NULL, NULL, TwinhawkInputInfo, TwinhawkDIPInfo,
...
struct BurnDriver BurnDrvTwinhawku = {
	...
	NULL, NULL, TwinhawkuRomInfo, TwinhawkuRomName, NULL, NULL, TwinhawkInputInfo, TwinhawkuDIPInfo,
	TwinhawkInit, TaitoXExit, TwinhawkFrame, NULL, TaitoXScan,
	NULL, 0x800, 224, 384, 3, 4
};
...
struct BurnDriver BurnDrvDaisenpu = {
	...
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_TAITOX, GBF_VERSHOOT, 0,
	NULL, NULL, DaisenpuRomInfo, DaisenpuRomName, NULL, NULL, TwinhawkInputInfo, DaisenpuDIPInfo,
	TwinhawkInit, TaitoXExit, TwinhawkFrame, NULL, TaitoXScan,
	NULL, 0x800, 224, 384, 3, 4
};
