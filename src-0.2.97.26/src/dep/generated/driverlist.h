...
#if defined FBA_DEBUG
	&BurnDrvDw2001,				// Dragon World 2001 (V100, Japan) [no comment]
...
#if defined FBA_DEBUG
	&BurnDrvdwpc,				// Dragon World Pretty Chance (V101, Japan) [no comment]
#endif
