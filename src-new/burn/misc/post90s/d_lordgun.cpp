...
struct BurnDriver BurnDrvLordgun = {
	...
	lordgunInit, DrvExit, lordgunFrame, lordgunDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	448, 224, 4, 3
};
...
struct BurnDriver BurnDrvAliencha = {
	...
	alienchaInit, DrvExit, alienchaFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	448, 224, 4, 3
};
...
struct BurnDriver BurnDrvAlienchac = {
	...
	alienchacInit, DrvExit, alienchaFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	448, 224, 4, 3
};
