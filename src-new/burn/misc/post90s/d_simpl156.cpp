...
struct BurnDriver BurnDrvJoemacr = {
	...
	joemacrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvChainrec = {
	...
	chainrecInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvMagdrop = {
	...
	magdropInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvMagdropp = {
	...
	magdroppInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCharlien = {
	...
	charlienInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvPrtytime = {
	...
	prtytimeInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvOsman = {
	...
	osmanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
