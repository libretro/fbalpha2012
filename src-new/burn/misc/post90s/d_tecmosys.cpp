...
struct BurnDriver BurnDrvDeroon = {
	...
	DeroonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x4800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvTkdensho = {
	...
	TkdenshoInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x4800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvTkdenshoa = {
	...
	TkdenshoaInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x4800,
	320, 240, 4, 3
};
