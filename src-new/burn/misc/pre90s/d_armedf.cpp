...
struct BurnDriver BurnDrvKozure = {
	...
	KozureInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriverD BurnDrvTerrafjb = {
	...
	TerrafjbInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
