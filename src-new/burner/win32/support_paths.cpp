...
static BOOL CALLBACK DefInpProc(HWND hDlg, UINT Msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (Msg) {
		case WM_INITDIALOG: {
			...
			SetDlgItemText(hDlg, IDC_SUPPORTDIR_EDIT22, szAppSamplesPath);
		...
		case WM_COMMAND: {
			...
			if (LOWORD(wParam) == IDOK) {
				...
				GetDlgItemText(hDlg, IDC_SUPPORTDIR_EDIT22, szAppSamplesPath,	sizeof(szAppSamplesPath));
