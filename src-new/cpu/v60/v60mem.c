...
UINT16 V60ProgramReadByte16LE(UINT32 Address)
{
	bprintf(PRINT_NORMAL, _T("Program Read Byte 16LE %x\n"), Address);
	
	return 0;
}

UINT16 V60ProgramReadWord16LE(UINT32 Address)
{
	bprintf(PRINT_NORMAL, _T("Program Read Word 16LE %x\n"), Address);
	
	return 0;
}

void V60ProgramWriteByte16LE(UINT32 Address, UINT32 Data)
{
	bprintf(PRINT_NORMAL, _T("Program Write Byte 16LE %x, %x\n"), Address, Data);
}

void V60ProgramWriteWord16LE(UINT32 Address, UINT32 Data)
{
	bprintf(PRINT_NORMAL, _T("Program Write Word 16LE %x, %x\n"), Address, Data);
}

#define program_read_byte_16le		V60ProgramReadByte16LE
#define program_read_word_16le		V60ProgramReadWord16LE
#define program_write_byte_16le		V60ProgramWriteByte16LE
#define program_write_word_16le		V60ProgramWriteWord16LE
