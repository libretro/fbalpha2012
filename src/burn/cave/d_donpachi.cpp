...
struct BurnDriver BurnDrvDonpachi = {
	...
	"DonPachi (US)\0", "ver. 1.01 1995/05/11", "Atlus / Cave", "Cave",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvDonpachij = {
	...
	"Donpachi (Japan)\0", "ver. 1.01 1995/05/11", "Atlus / Cave", "Cave",
	L"Donpachi (Japan, ver. 1.01 1995/05/11)\0\u9996\u9818\u8702 (Japan, ver. 1.01 1995/05/11)\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvDonpachikr = {
	...
	"Donpachi (Korea)\0", "ver. 1.12 1995/05/2x", "Atlus / Cave", "Cave",
	L"Donpachi (Korea, ver. 1.12 1995/05/2x)\0\u9996\u9818\u8702 (Korea, ver. 1.12 1995/05/2x)\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_CAVE_68K_ONLY | HARDWARE_CAVE_M6295,
...
struct BurnDriver BurnDrvDonpachihk = {
	...
	"Donpachi (Hong Kong)\0", "ver. 1.12 1995/05/2x", "Atlus / Cave", "Cave",
	L"Donpachi (Hong Kong, ver. 1.12 1995/05/2x)\0\u9996\u9818\u8702 (Hong Kong, ver. 1.12 1995/05/2x)\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_16BIT_ONLY, 2, HARDWARE_CAVE_68K_ONLY | HARDWARE_CAVE_M6295,
