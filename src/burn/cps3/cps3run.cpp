...
unsigned int cps3_key1, cps3_key2, cps3_isSpecial, cps3_redearthHack;
...
//	EEPROM[0x29] = 0x100 + (EEPROM[0x29] & 0xff);
	...
	Cps3Input[3] = 0;
      //0
		Cps3Input[0] |= (Cps3But1[0] & 1) << 0;
		Cps3Input[1] |= (Cps3But2[0] & 1) << 0;
		Cps3Input[3] |= (Cps3But3[0] & 1) << 0;

      //1
		Cps3Input[0] |= (Cps3But1[1] & 1) << 1;
		Cps3Input[1] |= (Cps3But2[1] & 1) << 1;
		Cps3Input[3] |= (Cps3But3[1] & 1) << 1;

      //2
		Cps3Input[0] |= (Cps3But1[2] & 1) << 2;
		Cps3Input[1] |= (Cps3But2[2] & 1) << 2;
		Cps3Input[3] |= (Cps3But3[2] & 1) << 2;

      //3
		Cps3Input[0] |= (Cps3But1[3] & 1) << 3;
		Cps3Input[1] |= (Cps3But2[3] & 1) << 3;
		Cps3Input[3] |= (Cps3But3[3] & 1) << 3;

      //4
		Cps3Input[0] |= (Cps3But1[4] & 1) << 4;
		Cps3Input[1] |= (Cps3But2[4] & 1) << 4;
		Cps3Input[3] |= (Cps3But3[4] & 1) << 4;

      //5
		Cps3Input[0] |= (Cps3But1[5] & 1) << 5;
		Cps3Input[1] |= (Cps3But2[5] & 1) << 5;
		Cps3Input[3] |= (Cps3But3[5] & 1) << 5;

      //6
		Cps3Input[0] |= (Cps3But1[6] & 1) << 6;
		Cps3Input[1] |= (Cps3But2[6] & 1) << 6;
		Cps3Input[3] |= (Cps3But3[6] & 1) << 6;

      //7
		Cps3Input[0] |= (Cps3But1[7] & 1) << 7;
		Cps3Input[1] |= (Cps3But2[7] & 1) << 7;
		Cps3Input[3] |= (Cps3But3[7] & 1) << 7;

      //8
		Cps3Input[0] |= (Cps3But1[8] & 1) << 8;
		Cps3Input[1] |= (Cps3But2[8] & 1) << 8;
		Cps3Input[3] |= (Cps3But3[8] & 1) << 8;

      //9
		Cps3Input[0] |= (Cps3But1[9] & 1) << 9;
		Cps3Input[1] |= (Cps3But2[9] & 1) << 9;
		Cps3Input[3] |= (Cps3But3[9] & 1) << 9;

      //10
		Cps3Input[0] |= (Cps3But1[10] & 1) << 10;
		Cps3Input[1] |= (Cps3But2[10] & 1) << 10;
		Cps3Input[3] |= (Cps3But3[10] & 1) << 10;

      //11
		Cps3Input[0] |= (Cps3But1[11] & 1) << 11;
		Cps3Input[1] |= (Cps3But2[11] & 1) << 11;
		Cps3Input[3] |= (Cps3But3[11] & 1) << 11;

      //12
		Cps3Input[0] |= (Cps3But1[12] & 1) << 12;
		Cps3Input[1] |= (Cps3But2[12] & 1) << 12;
		Cps3Input[3] |= (Cps3But3[12] & 1) << 12;

      //13
		Cps3Input[0] |= (Cps3But1[13] & 1) << 13;
		Cps3Input[1] |= (Cps3But2[13] & 1) << 13;
		Cps3Input[3] |= (Cps3But3[13] & 1) << 13;

      //14
		Cps3Input[0] |= (Cps3But1[14] & 1) << 14;
		Cps3Input[1] |= (Cps3But2[14] & 1) << 14;
		Cps3Input[3] |= (Cps3But3[14] & 1) << 14;

      //15
		Cps3Input[0] |= (Cps3But1[15] & 1) << 15;
		Cps3Input[1] |= (Cps3But2[15] & 1) << 15;
		Cps3Input[3] |= (Cps3But3[15] & 1) << 15;
