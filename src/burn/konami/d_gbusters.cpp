...
static struct BurnRomInfo gbustersaRomDesc[] = {
...
STD_ROM_PICK(gbustersa)
STD_ROM_FN(gbustersa)

struct BurnDriver BurnDrvGbustersa = {
	...
	NULL, gbustersaRomInfo, gbustersaRomName, GbustersInputInfo, GbustersDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 288, 3, 4
};
