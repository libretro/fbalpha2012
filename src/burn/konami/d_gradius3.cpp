...
static struct BurnRomInfo gradius3aRomDesc[] = {
...
STD_ROM_PICK(gradius3a)
STD_ROM_FN(gradius3a)

struct BurnDriver BurnDrvGradius3a = {
	"gradius3a", "gradius3", NULL, "1989",
	"Gradius III (Asia)\0", NULL, "Konami", "GX945",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, gradius3aRomInfo, gradius3aRomName, Gradius3InputInfo, Gradius3DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 224, 4, 3
};
...
static struct BurnRomInfo gradius3eRomDesc[] = {
...
STD_ROM_PICK(gradius3e)
STD_ROM_FN(gradius3e)

struct BurnDriver BurnDrvGradius3e = {
	"gradius3e", "gradius3", NULL, "1989",
	"Gradius III (World ?)\0", NULL, "Konami", "GX945",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, gradius3eRomInfo, gradius3eRomName, Gradius3InputInfo, Gradius3DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 224, 4, 3
};
