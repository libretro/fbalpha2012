...
struct BurnDriver BurnDrvMainevt = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 4, HARDWARE_PREFIX_KONAMI,
	NULL, mainevtRomInfo, mainevtRomName, MainevtInputInfo, MainevtDIPInfo,
	mainevtInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMainevto = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_KONAMI,
...
struct BurnDriver BurnDrvMainevt2p = {
	...
	NULL, mainevt2pRomInfo, mainevt2pRomName, Mainevt2pInputInfo, Mainevt2pDIPInfo,
	mainevtInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvRingohja = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, ringohjaRomInfo, ringohjaRomName, Mainevt2pInputInfo, Mainevt2pDIPInfo,
	mainevtInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvDevstors = {
	...
	devstorsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 304, 3, 4
};
...
struct BurnDriver BurnDrvDevstors2 = {
	...
	NULL, devstors2RomInfo, devstors2RomName, DevstorsInputInfo, Devstors2DIPInfo,
	devstorsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 304, 3, 4
};
...
struct BurnDriver BurnDrvDevstors3 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_PREFIX_KONAMI,
	NULL, devstors3RomInfo, devstors3RomName, DevstorsInputInfo, DevstorsDIPInfo,
	devstorsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 304, 3, 4
};
...
struct BurnDriver BurnDrvGaruka = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_PREFIX_KONAMI,
	NULL, garukaRomInfo, garukaRomName, DevstorsInputInfo, Devstors2DIPInfo,
	devstorsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 304, 3, 4
};
