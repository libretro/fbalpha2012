...
static void DrvRecalcPal()
{
	...
	for (int i = 0; i < 0x1000 / 2; i++) {
		unsigned short d = swapWord((p[i] << 8) | (p[i] >> 8));
...
struct BurnDriver BurnDrvSimpsons4pa = {
	...
	NULL, simpsons4paRomInfo, simpsons4paRomName, SimpsonsInputInfo, NULL,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvSimpsons2p = {
	...
	NULL, simpsons2pRomInfo, simpsons2pRomName, Simpsons2pInputInfo, NULL,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvSimpsons2p2 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, simpsons2p2RomInfo, simpsons2p2RomName, SimpsonsInputInfo, NULL,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvSimpsons2pa = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, simpsons2paRomInfo, simpsons2paRomName, Simpsons2pInputInfo, NULL,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvSimpsons2pj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, simpsons2pjRomInfo, simpsons2pjRomName, Simpsons2pInputInfo, NULL,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
