...
struct BurnDriver BurnDrvThunderxa = {
	...
	NULL, thunderxaRomInfo, thunderxaRomName, ThunderxInputInfo, ThunderxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvThunderxb = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, thunderxbRomInfo, thunderxbRomName, ThunderxInputInfo, ThunderxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvThunderxj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI,
	NULL, thunderxjRomInfo, thunderxjRomName, ThunderxInputInfo, ThunderxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	288, 224, 4, 3
};
