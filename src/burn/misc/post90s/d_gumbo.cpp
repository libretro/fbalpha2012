...
struct BurnDriver BurnDrvGumbo = {
	...
	GumboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 224, 4, 3
};
...
static struct BurnRomInfo mspuzzlegRomDesc[] = {
...
STD_ROM_PICK(mspuzzleg)
STD_ROM_FN(mspuzzleg)

struct BurnDriver BurnDrvMspuzzleg = {
	...
	NULL, mspuzzlegRomInfo, mspuzzlegRomName, GumboInputInfo, GumboDIPInfo,
	GumboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvMsbingo = {
	...
	MspuzzleInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvMspuzzlen = {
	...
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
...
static struct BurnRomInfo dblpointdRomDesc[] = {
...
STD_ROM_PICK(dblpointd)
STD_ROM_FN(dblpointd)

struct BurnDriver BurnDrvDblpointd = {
	"dblpointd", "dblpoint", NULL, "1995",
	"Double Point (Dong Bang Electron, bootleg?)\0", NULL, "Dong Bang Electron", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, dblpointdRomInfo, dblpointdRomName, DblpointInputInfo, DblpointDIPInfo,
	GumboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 224, 4, 3
};
