...
static void draw_sprite(int spriteno)
{
	...
	int yzoom = (swapWord(source[0]) & 0xf000) >> 12;
	int xzoom = (swapWord(source[1]) & 0xf000) >> 12;

	int ysize = (swapWord(source[0]) & 0x0e00) >> 9;
	int xsize = (swapWord(source[1]) & 0x0e00) >> 9;

	int ypos = swapWord(source[0]) & 0x01ff;
	int xpos = swapWord(source[1]) & 0x01ff;

	int yflip = swapWord(source[2]) & 0x8000;
	int xflip = swapWord(source[2]) & 0x4000;
	int color = (swapWord(source[2]) & 0x1f00) >> 8;

	int tile = swapWord(source[3]) & 0xffff;
