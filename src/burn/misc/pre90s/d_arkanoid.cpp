...
static unsigned int paletteSize;
...
static void DrvPaletteInit()
{
	for (int i = 0; i < paletteSize; i++)
	{
		...
		bit0 = (DrvColPROM[i + paletteSize * 0] >> 0) & 0x01;
		bit1 = (DrvColPROM[i + paletteSize * 0] >> 1) & 0x01;
		bit2 = (DrvColPROM[i + paletteSize * 0] >> 2) & 0x01;
		bit3 = (DrvColPROM[i + paletteSize * 0] >> 3) & 0x01;
		r = 0x0e * bit0 + 0x1f * bit1 + 0x43 * bit2 + 0x8f * bit3;

		bit0 = (DrvColPROM[i + paletteSize * 1] >> 0) & 0x01;
		bit1 = (DrvColPROM[i + paletteSize * 1] >> 1) & 0x01;
		bit2 = (DrvColPROM[i + paletteSize * 1] >> 2) & 0x01;
		bit3 = (DrvColPROM[i + paletteSize * 1] >> 3) & 0x01;
		g = 0x0e * bit0 + 0x1f * bit1 + 0x43 * bit2 + 0x8f * bit3;

		bit0 = (DrvColPROM[i + paletteSize * 2] >> 0) & 0x01;
		bit1 = (DrvColPROM[i + paletteSize * 2] >> 1) & 0x01;
		bit2 = (DrvColPROM[i + paletteSize * 2] >> 2) & 0x01;
		bit3 = (DrvColPROM[i + paletteSize * 2] >> 3) & 0x01;
...
struct BurnDriver BurnDrvarkmcubl = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvarkgcbla = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 1, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvHexa = {
	...
	HexaInit, DrvExit, DrvFrame, DrvDraw, HexaScan, &DrvRecalc,
	256, 224, 4, 3
};
