...
static struct BurnInputInfo BlockoutjInputList[] = {
	{"Coin 1",		BIT_DIGITAL,	DrvJoy3 + 1,	"p1 coin"  },
	{"Coin 2",		BIT_DIGITAL,	DrvJoy3 + 2,	"p2 coin"  },
	{"Coin 3",		BIT_DIGITAL,	DrvJoy3 + 3,	"p3 coin"  },
...
static void update_pixels(int offset)
{
	...
	int front = swapWord(src[0x00000]);
	int back  = swapWord(src[0x10000]);
...
static struct BurnRomInfo blockout2RomDesc[] = {
...
STD_ROM_PICK(blockout2)
STD_ROM_FN(blockout2)

struct BurnDriver BurnDrvBlockout2 = {
	...
	NULL, blockout2RomInfo, blockout2RomName, BlockoutInputInfo, BlockoutDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 240, 4, 3
};
...
static struct BurnRomInfo blockoutjRomDesc[] = {
...
STD_ROM_PICK(blockoutj)
STD_ROM_FN(blockoutj)

struct BurnDriver BurnDrvBlockoutj = {
	"blockoutj", "blockout", NULL, "1989",
	"Block Out (Japan)\0", NULL, "Technos + California Dreams", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, blockoutjRomInfo, blockoutjRomName, BlockoutjInputInfo, BlockoutDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	320, 240, 4, 3
};
