...
static struct BurnRomInfo dotrikun2RomDesc[] = {
	{ "14479.mpr",	0x4000, 0xa6aa7fa5, BRF_ESS | BRF_PRG }, //  Z80 code
};

STD_ROM_PICK(dotrikun2)
STD_ROM_FN(dotrikun2)

struct BurnDriver BurnDrvdotrikun2 = {
	...
	NULL, dotrikun2RomInfo, dotrikun2RomName, DrvInputInfo, NULL,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 192, 4, 3
};
