...
struct BurnDriver BurnDrvMegadon = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 1, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvCatapult = {
	"catapult", NULL, NULL, "1982",
	"Catapult\0", "Bad dump", "Epos Corporation", "EPOS Tristar",
	NULL, NULL, NULL, NULL,
	BDF_ORIENTATION_VERTICAL, 1, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvTheglob = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 1, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvDealer = {
	...
	DealerInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	236, 272, 3, 4
};
