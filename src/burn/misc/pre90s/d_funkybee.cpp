...
static struct BurnDIPInfo funkybeebDIPList[]=
{
	// Default Values
	{0x0f, 0xff, 0xff, 0x20, NULL                     },
...
static struct BurnDIPInfo skylancreDIPList[]=
{
	// Default Values
	{0x0f, 0xff, 0xff, 0x20, NULL                     },
...
static struct BurnRomInfo funkybeebRomDesc[] = {
...
STD_ROM_PICK(funkybeeb)
STD_ROM_FN(funkybeeb)

struct BurnDriver BurnDrvfunkybeeb = {
	...
	NULL, funkybeebRomInfo, funkybeebRomName, DrvInputInfo, funkybeebDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPal,
	224, 232, 3, 4
};
...
static struct BurnRomInfo skylancreRomDesc[] = {
...
STD_ROM_PICK(skylancre)
STD_ROM_FN(skylancre)

struct BurnDriver BurnDrvskylancre = {
	"skylancre", "skylancr", NULL, "1983",
	"Sky Lancer (Esco Trading Co license)\0", NULL, "Orca (Esco Trading Co license)", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
	NULL, skylancreRomInfo, skylancreRomName, DrvInputInfo, skylancreDIPInfo,
	skylancrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalcPal,
	224, 232, 3, 4
};
