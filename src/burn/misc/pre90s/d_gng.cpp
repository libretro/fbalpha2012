...
static struct BurnRomInfo MakaimurcRomDesc[] = {
...
STD_ROM_PICK(Makaimurc)
STD_ROM_FN(Makaimurc)

static struct BurnRomInfo MakaimurgRomDesc[] = {
...
STD_ROM_PICK(Makaimurg)
STD_ROM_FN(Makaimurg)
...
struct BurnDriver BurnDrvMakaimurc = {
	"makaimurc", "gng", NULL, "1985",
	"Makai-Mura (Japan revision C)\0", NULL, "Capcom", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, MakaimurcRomInfo, MakaimurcRomName, DrvInputInfo, DrvjDIPInfo,
	DrvInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 256, 224, 4, 3
};

struct BurnDriver BurnDrvMakaimurg = {
	"makaimurg", "gng", NULL, "1985",
	"Makai-Mura (Japan revision G)\0", NULL, "Capcom", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, MakaimurgRomInfo, MakaimurgRomName, DrvInputInfo, DrvjDIPInfo,
	DrvInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 256, 224, 4, 3
};
