...
struct BurnDriver BurnDrvGunsmokej = {
	...
	NULL, gunsmokejRomInfo, gunsmokejRomName, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvCalcPal,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGunsmokeu = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_MISC,
	NULL, gunsmokeuRomInfo, gunsmokeuRomName, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvCalcPal,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGunsmokeua = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_MISC,
	NULL, gunsmokeuaRomInfo, gunsmokeuaRomName, DrvInputInfo, gunsmokeuaDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvCalcPal,
	224, 256, 3, 4
};
