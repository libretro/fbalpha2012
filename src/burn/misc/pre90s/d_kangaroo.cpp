...
struct BurnDriver BurnDrvfnkyfish = {
	...
	NULL, NULL, NULL, NULL,
	BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvkangarooa = {
	...
	NULL, kangarooaRomInfo, kangarooaRomName, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL,
//	JBF_GAME_WORKING, DrvJukeboxInit, DrvJukeboxExit, DrvJukeboxFrame,
	&DrvRecalc, 256, 512, 3, 4
};
...
struct BurnDriver BurnDrvkangaroob = {
	...
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
	NULL, kangaroobRomInfo, kangaroobRomName, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, NULL,
//	JBF_GAME_WORKING, DrvJukeboxInit, DrvJukeboxExit, DrvJukeboxFrame,
	&DrvRecalc, 256, 512, 3, 4
};
