...
inline void KyugoMakeInputs()
{
	...
	// Clear Opposites
	DrvClearOpposites(&KyugoInput[1]);
	DrvClearOpposites(&KyugoInput[2]);
}
...
static struct BurnRomInfo Skywolf3RomDesc[] = {
	...
	{ "2.bin",         0x08000, 0xf02143de, BRF_ESS | BRF_PRG }, //  1	Z80 #1 Program Code
...
static int KyugoInit()
{
	...
	if (!strcmp(BurnDrvGetTextA(DRV_NAME), "airwolf") || !strcmp(BurnDrvGetTextA(DRV_NAME), "airwolfa") || !strcmp(BurnDrvGetTextA(DRV_NAME), "skywolf") || !strcmp(BurnDrvGetTextA(DRV_NAME), "skywolf2") || !strcmp(BurnDrvGetTextA(DRV_NAME), "skywolf3")) {
		ZetOpen(0);
