...
struct BurnDriver BurnDrvLadybug = {
	...
	LadybugInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvCavenger = {
	...
	CavengerInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	240, 196, 4, 3
};
...
struct BurnDriver BurnDrvDorodon = {
	...
	DorodonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	196, 240, 3, 4
};
...
struct BurnDriver BurnDrvSraider = {
	...
	SraiderInit, DrvExit, SraiderFrame, SraiderDraw, DrvScan, &DrvRecalc,
	196, 240, 3, 4
};
