...
struct BurnDriver BurnDrvSectionza = {
	...
	NULL, sectionzaRomInfo, sectionzaRomName, DrvInputInfo, SectionzDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvLwingsj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
	NULL, lwingsjRomInfo, lwingsjRomName, DrvInputInfo, LwingsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvTrojan = {
	...
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvAvengers = {
	...
	AvengersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	240, 256, 3, 4
};
...
static struct BurnRomInfo avengers2RomDesc[] = {
...
STD_ROM_PICK(avengers2)
STD_ROM_FN(avengers2)

struct BurnDriver BurnDrvAvengers2 = {
	"avengers2", "avengers", NULL, "1987",
	"Avengers (US set 2)\0", NULL, "Capcom", "hardware",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_MISC,
	NULL, avengers2RomInfo, avengers2RomName, DrvInputInfo, AvengersDIPInfo,
	AvengersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	240, 256, 3, 4
};
