...
#else
	BurnYM2413Init(4000000, 60.0);	
	BurnYM2413IncreaseVolume(10);
	MSM6295Init(0, 1000000 / 132, 10.0, 1);
#endif
...
struct BurnDriver BurnDrvBlockj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_CLONE, 2, HARDWARE_MISC_MISC,
...
struct BurnDriver BurnDrvBlockbl = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_MISC_MISC,
