...
static struct BurnRomInfo myststonoRomDesc[] = {
...
STD_ROM_PICK(myststono)
STD_ROM_FN(myststono)

struct BurnDriver BurnDrvmyststono = {
	...
	NULL, myststonoRomInfo, myststonoRomName, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	240, 256, 3, 4
};
