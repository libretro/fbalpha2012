...
static struct BurnInputInfo woodpeckInputList[] = {
	{"Coin 1",		  BIT_DIGITAL,	DrvJoy1 + 5,	"p1 coin"},
	{"Coin 2",		  BIT_DIGITAL,	DrvJoy1 + 6,	"p2 coin"},
	{"Start 1",		  BIT_DIGITAL,	DrvJoy2 + 5,	"p1 start"},
	{"Start 2",		  BIT_DIGITAL,	DrvJoy2 + 6, 	"p2 start"},
...
static struct BurnDIPInfo woodpeckDIPList[]=
{
	// Default Values
	{0x10, 0xff, 0xff, 0xff, NULL                     },
...
struct BurnDriver BurnDrvpuckman = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_PACMAN,
...
struct BurnDriver BurnDrvpuckmanf = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PACMAN,
...
static struct BurnRomInfo popeyemanRomDesc[] = {
	...
	{ "2.6m",         0x0800, 0xbaf5461e, 1 | BRF_ESS | BRF_PRG },	//  3
...
struct BurnDriver BurnDrvcrushbl2 = {
	"crushbl2", "crush", NULL, "1981",
	"Crush Roller (bootleg?)\0", NULL, "Kural Samno Electric", "Pac-man",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PACMAN,
	NULL, crushbl2RomInfo, crushbl2RomName, DrvInputInfo, maketraxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvwoodpeck = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_PACMAN,
	NULL, woodpeckRomInfo, woodpeckRomName, woodpeckInputInfo, woodpeckDIPInfo,
	woodpeckInit, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	224, 288, 3, 4
};
...
static struct BurnRomInfo woodpecaRomDesc[] = {
...
STD_ROM_PICK(woodpeca)
STD_ROM_FN(woodpeca)

struct BurnDriver BurnDrvwoodpeca = {
	"woodpeca", "woodpeck", NULL, "1981",
	"Woodpecker (set 2)\0", NULL, "Amenip", "Pac-man",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PACMAN,
	NULL, woodpecaRomInfo, woodpecaRomName, woodpeckInputInfo, woodpeckDIPInfo,
	woodpeckInit, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvponpoko = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_PACMAN,
...
struct BurnDriver BurnDrvponpokov = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_PACMAN,
