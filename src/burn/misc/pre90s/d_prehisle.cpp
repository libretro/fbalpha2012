...
inline void PrehisleMakeInputs()
{
	...
	// Clear Opposites
	DrvClearOpposites(&PrehisleInput[0]);
	DrvClearOpposites(&PrehisleInput[1]);
}
...
static struct BurnRomInfo PrehisleuRomDesc[] = {
...
STD_ROM_PICK(Prehisleu)
STD_ROM_FN(Prehisleu)
...
struct BurnDriver BurnDrvPrehisleu = {
	...
	NULL, PrehisleuRomInfo, PrehisleuRomName, PrehisleInputInfo, PrehisleDIPInfo,
	PrehisleInit, PrehisleExit, PrehisleFrame, NULL, PrehisleScan,
	NULL, 256, 224, 4, 3
};
