...
static struct BurnRomInfo stratvoxbRomDesc[] = {
...
STD_ROM_PICK(stratvoxb)
STD_ROM_FN(stratvoxb)

struct BurnDriver BurnDrvstratvoxb = {
	"stratvoxb", "speakres", NULL, "1980",
	"Stratovox (bootleg)\0", NULL, "bootleg", "Route 16",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, stratvoxbRomInfo, stratvoxbRomName, DrvInputInfo, stratvoxDIPInfo,
	speakresInit, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	256, 256, 3, 4
};
