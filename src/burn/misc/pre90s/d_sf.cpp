...
static void draw_sprites()
{
	...
	{
		int c = swapWord(sf_objectram[offs]);
		int attr = swapWord(sf_objectram[offs+1]);
		int sy = swapWord(sf_objectram[offs+2]);
		int sx = swapWord(sf_objectram[offs+3]);
...
static struct BurnRomInfo sfjRomDesc[] = {
	...
	{ "68705.bin",   0x0800, 0x00000000, 0 | BRF_NODUMP },
};
...
struct BurnDriver BurnDrvsfj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, sfjRomInfo, sfjRomName, SfjInputInfo, SfusDIPInfo,
...
struct BurnDriver BurnDrvsfp = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_MISC_MISC,
