...
struct BurnDriver BurnDrvRygar = {
	...
	RygarInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvSilkworm = {
	...
	SilkwormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
static struct BurnRomInfo silkworm2RomDesc[] = {
...
STD_ROM_PICK(silkworm2)
STD_ROM_FN(silkworm2)

struct BurnDriver BurnDrvSilkworm2 = {
	"silkworm2", "silkworm", NULL, "1988",
	"Silk Worm (set 2)\0", NULL, "Tecmo", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, silkworm2RomInfo, silkworm2RomName, SilkwormInputInfo, SilkwormDIPInfo,
	SilkwormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvbackfirt = {
	...
	GeminiInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
