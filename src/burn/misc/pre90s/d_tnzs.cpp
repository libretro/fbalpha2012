...
struct BurnDriver BurnDrvPlumppop = {
	...
	PlumppopInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvExtrmatn = {
	...
	ExtrmatnInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvArknoid2 = {
	...
	Arknoid2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDrtoppel = {
	...
	DrtoppelInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvKageki = {
	...
	KagekiInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvChukatai = {
	...
	ChukataiInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvTnzsjo = {
	...
	TnzsoInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvInsectx = {
	...
	InsectxInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
static struct BurnRomInfo insectxjRomDesc[] = {
	...
	{ "b97-04.u38",		0x10000, 0xdc4549e5, 2 | BRF_PRG | BRF_ESS }, //  1 Z80 #1 Code
...
struct BurnDriver BurnDrvInsectxj = {
	"insectxj", "insectx", NULL, "1989",
	"Insector X (Japan)\0", NULL, "Taito Corporation", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_MISC,
	NULL, insectxjRomInfo, insectxjRomName, InsectxInputInfo, InsectxDIPInfo,
	InsectxInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvJpopnics = {
	...
	JpopnicsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc,
	256, 224, 4, 3
};
