...
static struct BurnRomInfo pgmRomDesc[] = {
	...
	{ "pgm_p02s.rom", 0x020000, 0x78C15FA2, BRF_PRG | BRF_BIOS },	// 0x83 - 68K BIOS (V0001, newer - 07/10/97 - 16:36:08)
};
...
//	{ "",		  0,	    0,		0		   },
// Too lazy to make a special dip case, so just fudge it for now
	{ "bios.u42",     0x020000, 0x517CF7A2, BRF_PRG | BRF_BIOS },	// 0x82 - 68K BIOS (V0001-01J, custom? 02/25/03 17:51:01)
...
{
	pPgmProtCallback = install_protection_asic3;
...
struct BurnDriver BurnDrvOrlegend112e = {
	"orlegend112e", "orlegend", "pgm", /*NULL,*/ "1997",
...
struct BurnDriver BurnDrvOrlegend112c = {
	"orlegend112c", "orlegend", "pgm", /*NULL,*/ "1997",
...
struct BurnDriver BurnDrvOrlegend112ca = {
	"orlegend112ca", "orlegend", "pgm", /*NULL,*/ "1997",
...
#else
	*((unsigned short*)(PGM68KROM + 0x031098)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x03113e)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x0311ce)) = 0x934e;
...
static int drgw2Init()
{
	...
	pPgmProtCallback = install_protection_dw2;
...
#else
	*((unsigned short*)(PGM68KROM + 0x0303bc)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x030462)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x0304F2)) = 0x934e;
#endif
}
...
struct BurnDriver BurnDrvDrgw2100c = {
	...
	NULL, drgw2100cRomInfo, drgw2100cRomName, /*NULL, NULL ,*/ pgmInputInfo, pgmDIPInfo,
	drgw2100cInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
#else	 
	*((unsigned short*)(PGM68KROM + 0x0302C0)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x030366)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x0303F6)) = 0x934e;
#endif
}
...
struct BurnDriver BurnDrvDrgw2100j = {
	...
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM, //GBF_PUZZLE, 0,
	NULL, drgw2100jRomInfo, drgw2100jRomName, /*NULL, NULL ,*/ pgmInputInfo, pgmDIPInfo,
	drgw2100jInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
#ifdef LSB_FIRST
	*((unsigned short*)(PGM68KROM + 0x031084)) = 0x4e93;
	*((unsigned short*)(PGM68KROM + 0x03112A)) = 0x4e93;
	*((unsigned short*)(PGM68KROM + 0x0311BA)) = 0x4e93;
#else
	*((unsigned short*)(PGM68KROM + 0x031084)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x03112A)) = 0x934e;
	*((unsigned short*)(PGM68KROM + 0x0311BA)) = 0x934e;
#endif
}
...
struct BurnDriver BurnDrvDrgw2100x = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_IGS_PGM, //GBF_PUZZLE, 0,
	NULL, drgw2100xRomInfo, drgw2100xRomName, /*NULL, NULL ,*/ pgmInputInfo, pgmDIPInfo,
	drgw2100xInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
static int killbldInit()
{
	...
	pPgmProtCallback = install_protection_killbld; // ASIC025/ASIC022
...
struct BurnDriver BurnDrvKillbld = {
	...
	killbldInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
static int oldsInit()
{
	pPgmProtCallback = install_protection_olds;
...
static int kovInit()
{
	...
	pPgmProtCallback = install_protection_kov_asic27;
...
static int kovshInit()
{
	...
	pPgmProtCallback = install_protection_kovsh_asic27a;
...
static int puzlstarInit()
{
	...
	pPgmProtCallback = install_protection_puzlstar_asic27a;
//	pPgmProtCallback = install_protection_kovsh_asic27a;
...
#else
	*((unsigned short*)(PGM68KROM + 0x0268c0)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x0268c2)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x0268c4)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x03877a)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x04cee0)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x0548ec)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x0548fc)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x054948)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x05496A)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x0549FA)) = 0x714e;
	*((unsigned short*)(PGM68KROM + 0x054A0A)) = 0x714e;
#endif
}
...
static int martmastInit()
{
	...
	pPgmProtCallback = install_protection_asic27A;
...
struct BurnDriverD BurnDrvPy2k2 = {
	...
	py2k2Init, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
#ifdef LSB_FIRST
	*((unsigned short*)(PGMUSER0 + 0x0000de)) = 0x46c0;
	*((unsigned short*)(PGMUSER0 + 0x1ffffc)) = 0x9933;
#else
	*((unsigned short*)(PGMUSER0 + 0x0000de)) = 0xc046;
	*((unsigned short*)(PGMUSER0 + 0x1ffffc)) = 0x3399;
#endif
...
static int ddp2Init()
{
	...
	pPgmProtCallback = install_protection_ddp2_asic27a;
//	pPgmProtCallback = install_protection_asic27A;
...
struct BurnDriverD BurnDrvDdp2102 = {
	"ddp2102", "ddp2", "pgm", /*NULL,*/ "2001",
	...
	BDF_ORIENTATION_VERTICAL | BDF_CLONE, 4, HARDWARE_IGS_PGM/* | HARDWARE_IGS_USE_ARM_CPU */, //GBF_VERSHOOT, 0,
	NULL, ddp2102RomInfo, ddp2102RomName, /*NULL, NULL ,*/ pgmInputInfo, ddp2DIPInfo,
	ddp2Init, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	224,448,3,4
};
...
{
	nPGMEnableIRQ4 = 1;
	pPgmInitCallback = pgm_decrypt_dw2001;
	pPgmProtCallback = install_protection_asic27A;
...
struct BurnDriverD BurnDrvDw2001 = {
	...
	"Dragon World 2001\0", NULL, "IGS", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	0, 4, HARDWARE_IGS_PGM /* | HARDWARE_IGS_USE_ARM_CPU*/, //GBF_PUZZLE, 0,
	NULL, dw2001RomInfo, dw2001RomName, /*NULL, NULL ,*/ pgmInputInfo, pgmDIPInfo,
	dw2001Init, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
//	pPgmProtCallback = install_protection_svg_asic27a;
...
struct BurnDriverD BurnDrvhappy6in1 = {
	...
	NULL, happy6in1RomInfo, happy6in1RomName, /*NULL, NULL ,*/ pgmInputInfo, pgmDIPInfo,
...
static struct BurnRomInfo oldsplusRomDesc[] = {
	{ "p05301.rom",			0x400000, 0x923f7246, 1 | BRF_ESS | BRF_PRG  },	//  0 68K Code
...
struct BurnDriverD BurnDrvoldsplus = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 4, HARDWARE_IGS_PGM, //GBF_MISC, 0,
...
// DoDonPachi Dai-Ou-Jou (V100, Japan)

static struct BurnRomInfo ddp3RomDesc[] = {
	{ "ddp3_d_d_1_0.u36",		0x200000, 0x5D3F85BA, 1 | BRF_PRG | BRF_ESS },		//  0 68K Code

	{ "t04401w064.u19",		0x800000, 0x3a95f19c, 2 | BRF_GRA | BRF_NODUMP },	//  1 Tile data

	{ "a04401w064.u7",		0x800000, 0xed229794, 3 | BRF_GRA | BRF_NODUMP },	//  2 Sprite Color Data
	{ "a04402w064.u8",		0x800000, 0xf7816273, 3 | BRF_GRA | BRF_NODUMP },	//  3

	{ "b04401w064.u1",		0x800000, 0x830aab7d, 4 | BRF_GRA | BRF_NODUMP },	//  4 Sprite Masks & Color Indexes

	{ "m04401b032.u17",		0x400000, 0xa118560c, 5 | BRF_SND | BRF_NODUMP },	//  5 Samples

	{ "ddpdoj_igs027a.bin",		0x004000, 0x00000000, 7 | BRF_PRG | BRF_NODUMP },	//  6 Internal ARM7 Rom
};
...
static int ddp3Init()
{
	...
	pPgmProtCallback = install_protection_ddp3;

	return pgmInit();
}

struct BurnDriver BurnDrvDdp3 = {
	"ddp3", NULL, "pgm", /*NULL,*/ "2002",
	"DoDonPachi Dai-Ou-Jou (V100, Japan)\0", "Incomplete Protection Simulation", "Cave / AMI", "PolyGameMaster",
	NULL, NULL, NULL, NULL,
	...
	ddp3Init, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	224, 448, 3, 4
};
...
static struct BurnRomInfo ddp3blkRomDesc[] = {
	...
	{ "ddp3blk.nv",		   	0x020000, 0xb9ce04e8, 0 | BRF_OPT },			//  7 NV RAM (patch below instead)
};
...
struct BurnDriver BurnDrvDdp3blk = {
	...
	ddp3blkInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	224, 448, 3, 4
};
...
static struct BurnRomInfo ketRomDesc[] = {
	...
	{ "B04701W064.u1",		0x800000, 0xb73634f4, 4 | BRF_GRA },		//  4 Sprite Masks & Color Indexes

	{ "M04701B032.u17",		0x400000, 0xb46e22d1, 5 | BRF_SND },		//  5 Samples

	{ "ketsui_igs027a.bin",		0x004000, 0x00000000, 7 | BRF_PRG | BRF_NODUMP }, // 6 Internal ARM7 Rom
};

STDROMPICKEXT(ket, ket, ketsuiBios) /* custom bios */
STD_ROM_FN(ket)

static void ketsui_enable_asic27a_test_mode()
{
	pgm_decrypt_ketsui();

//	*((unsigned short*)(PGM68KROM + 0xa719e)) = 0x0012; // 0008
}

static int ketsuiInit()
{
	nPGMEnableIRQ4 = 1;
	pPgmInitCallback = ketsui_enable_asic27a_test_mode; // pgm_decrypt_ketsui;
	pPgmProtCallback = install_protection_ketsui;
...
struct BurnDriver BurnDrvKet = {
	...
	ketsuiInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	224, 448, 3, 4
};
...
static struct BurnRomInfo espgalRomDesc[] = {
	{ "espgala_v100.u29",		0x200000, 0x08ecec34, 1 | BRF_PRG | BRF_ESS },		//  0 68K Code

	{ "T04801W064.u19",		0x800000, 0x00000000, 2 | BRF_GRA | BRF_NODUMP },	//  1 Tile data

	{ "A04801W064.u7",		0x800000, 0x00000000, 3 | BRF_GRA | BRF_NODUMP },	//  2 Sprite Color Data
	{ "A04802W064.u8",		0x800000, 0x00000000, 3 | BRF_GRA | BRF_NODUMP },	//  3

	{ "B04801W064.u1",		0x800000, 0x00000000, 4 | BRF_GRA | BRF_NODUMP },	//  4 Sprite Masks & Color Indexes

	{ "W04801B032.u17",		0x400000, 0x00000000, 5 | BRF_SND | BRF_NODUMP },	//  5 Samples

	{ "espgaluda_igs027a.bin",	0x004000, 0x00000000, 7 | BRF_PRG | BRF_NODUMP },	//  6 Internal ARM7 Rom
};

STDROMPICKEXT(espgal, espgal, ketsuiBios) /* custom bios */
STD_ROM_FN(espgal)
...
struct BurnDriverD BurnDrvEspgal = {
	...
	espgalInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	224, 448, 3, 4
};
...
struct BurnDriverD BurnDrvThegladpcb = {
	...
	0, 4, HARDWARE_IGS_PGM /* | HARDWARE_IGS_USE_ARM_CPU */, //GBF_SCRFIGHT, 0,
	NULL, thegladpcbRomInfo, thegladpcbRomName, /*NULL, NULL ,*/ pgmInputInfo, pgmDIPInfo,
	thegladpcbInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
...
struct BurnDriverD BurnDrvkovassg = {
	...
	kovassgInit, pgmExit, pgmFrame, pgmDraw, pgmScan, /*0, NULL, NULL, NULL,*/ &nPgmPalRecalc, /*0x1200,*/
	448, 224, 4, 3
};
