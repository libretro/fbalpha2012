...
static int MemIndex(int gfxsize)
{
	...
	pPsikyoshPalSrc	= (unsigned int  *)Next; Next += 0x1400 * sizeof(int);
...
struct BurnDriver BurnDrvSoldivid = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_PSIKYO,
	NULL, soldividRomInfo, soldividRomName, Common3ButtonInputInfo, SoldividDIPInfo,
	SoldividInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvS1945ii = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_PSIKYO,
	NULL, s1945iiRomInfo, s1945iiRomName, Common2ButtonInputInfo, S1945iiDIPInfo,
	S1945iiInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvDaraku = {
	...
	DarakuInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvSbomberb = {
	...
	SbomberbInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvGunbird2 = {
	...
	Gunbird2Init, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvS1945iii = {
	...
	S1945iiiInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvDragnblz = {
	...
	DragnblzInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvGnbarich = {
	...
	GnbarichInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvMjgtaste = {
	...
	MjgtasteInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvTgm2 = {
	...
	Tgm2Init, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvTgm2p = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PSIKYO,
	NULL, tgm2pRomInfo, tgm2pRomName, Common3ButtonInputInfo, Tgm2DIPInfo,
	Tgm2pInit, DrvExit, DrvFrame, PsikyoshDraw, DrvScan, NULL,
	320, 240, 4, 3
};
