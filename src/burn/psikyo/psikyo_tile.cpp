        ...
        for (nTileYPos = -16 + by, y = -mx; nTileYPos < 224; nTileYPos += 16, y += mx) {
                ...
                if (PsikyoLayerAttrib[nLayer] & 0x0300) {
                        if (PsikyoLayerAttrib[nLayer] & 0x0200) {
                                ...
                                minx = (short)swapWord(pTileRowInfo[(nTileYPos >> 4) & 0x0F]);
                        } else {
                                ...
                                for (int i = 0; i < 16; i++) {
                                        if ((short)swapWord(pTileRowInfo[(nTileYPos + i) & 0xFF]) > maxx) {
                                                maxx = (short)swapWord(pTileRowInfo[(nTileYPos + i) & 0xFF]);
                                        }
                                        if ((short)swapWord(pTileRowInfo[(nTileYPos + i) & 0xFF]) < minx) {
                                                minx = (short)swapWord(pTileRowInfo[(nTileYPos + i) & 0xFF]);
                                        }
                                }
                                ...
                                if (minx != maxx) {
                                        ...
                                        for (x = minx, nTileXPos = (minx << 4) + bx; x < maxx; x++, nTileXPos += 16) {
                                                ...
                                                nTileNumber = swapWord(pTileRAM[nTileRow + nTileColumn]);
...
int PsikyoTileRender()
{
        ...
        PsikyoLayerAttrib[0]  = swapWord(*((short*)(PsikyoTileRAM[2] + 0x0412)));
        PsikyoLayerXOffset[0] = swapWord(*((short*)(PsikyoTileRAM[2] + 0x0406)));
        PsikyoLayerYOffset[0] = swapWord(*((short*)(PsikyoTileRAM[2] + 0x0402)));

        PsikyoLayerAttrib[1]  = swapWord(*((short*)(PsikyoTileRAM[2] + 0x0416)));
        PsikyoLayerXOffset[1] = swapWord(*((short*)(PsikyoTileRAM[2] + 0x040E)));
        PsikyoLayerYOffset[1] = swapWord(*((short*)(PsikyoTileRAM[2] + 0x040A)));
