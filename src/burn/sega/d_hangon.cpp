...
static struct BurnRomInfo ShangupbRomDesc[] = {
	...
	{ "epr-10652.28",     0x08000, 0x260286f9, SYS16_ROM_TILES | BRF_GRA },
	{ "epr-10651.23",     0x08000, 0xc609ee7b, SYS16_ROM_TILES | BRF_GRA },
	{ "epr-10650.7",      0x08000, 0xb236a403, SYS16_ROM_TILES | BRF_GRA },
...
{
	// Inputs
	*((unsigned short*)(System16Ram + 0x0492)) = swapWord((unsigned short)((SharrierProcessAnalogControls(0) << 8) | SharrierProcessAnalogControls(1)));
}
...
struct BurnDriver BurnDrvShangonro = {
	"shangonro", "shangon", NULL, "1985",
	"Super Hang-On (Japan, FD1094 317-0038)\0", NULL, "Sega", "Hang-On",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_SEGA_HANGON | HARDWARE_SEGA_YM2203,
	NULL, ShangonroRomInfo, ShangonroRomName, ShangupbInputInfo, ShangupbDIPInfo,
	HangonInit, System16Exit, HangonFrame, NULL, System16Scan,
	NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvShangupb = {
	"shangonrb", "shangon", NULL, "1985",
