...
{
	// System Inputs
	*((unsigned short*)(System16Ram + 0x30c2)) = swapWord((unsigned short)(System16Input[0] << 8));
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x30c4)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
{
	// System Inputs
	*((unsigned short*)(System16Ram + 0x30d0)) = swapWord((unsigned short)(System16Input[0] << 8));
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x30d4)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
{
	// System Inputs
	*((unsigned short*)(System16Ram + 0x3096)) = swapWord((unsigned short)(System16Input[0] << 8));
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x3098)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x0bd0)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
void Goldnaxe_Sim8751()
{
	...
	if (temp1 == 0 && temp2 == 0 && temp3 == 0 && temp4 == 0) {
		*((unsigned short*)(System16Ram + 0x2cd8)) = swapWord(0x048c);
		*((unsigned short*)(System16Ram + 0x2cda)) = swapWord(0x159d);
		*((unsigned short*)(System16Ram + 0x2cdc)) = swapWord(0x26ae);
		*((unsigned short*)(System16Ram + 0x2cde)) = swapWord(0x37bf);
	}
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x2cfc)) = swapWord((unsigned short)(temp & 0xff));
	}

	// Inputs
	*((unsigned short*)(System16Ram + 0x2cd0)) = swapWord((unsigned short)(~((System16Input[1] << 8) | System16Input[2])));
	*((unsigned short*)(System16Ram + 0x2c96)) = swapWord((unsigned short)(~System16Input[0] << 8));
}
...
{
	// Inputs
	*((unsigned short*)(System16Ram + 0x01e6)) = swapWord((unsigned short)(~System16Input[0] << 8));
	*((unsigned short*)(System16Ram + 0x01e8)) = swapWord((unsigned short)(~System16Input[1] << 8));
	*((unsigned short*)(System16Ram + 0x01ea)) = swapWord((unsigned short)(~System16Input[2] << 8));
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x01d0)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x0008)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
{
	// System Inputs
	*((unsigned short*)(System16Ram + 0x2082)) = swapWord((unsigned short)~System16Input[0]);
...
//		ZetRaiseIrq(0);
		ZetSetIRQLine(0, ZET_IRQSTATUS_ACK);
		ZetClose();
		*((unsigned short*)(System16Ram + 0x208e)) = swapWord((unsigned short)(temp & 0xff));
	}
}
...
struct BurnDriver BurnDrvAtomicp = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_SEGA_SYSTEM16B | HARDWARE_SEGA_YM2413,
...
struct BurnDriver BurnDrvPassshtb = {
	"passshtb", "passsht", NULL, "1988",
	"Passing Shot (bootleg, 2 Players)\0", NULL, "Sega", "System 16B",
	NULL, NULL, NULL, NULL,
	BDF_ORIENTATION_VERTICAL | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_SEGA_SYSTEM16B | HARDWARE_SEGA_5358,
...
struct BurnDriver BurnDrvWb3bbl = {
	"wb3bbl", "wb3", NULL, "1988",
	"Wonder Boy III - Monster Lair (bootleg)\0", NULL, "bootleg", "System 16B",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_SEGA_SYSTEM16B | HARDWARE_SEGA_INVERT_TILES,
