...
static inline void System16ClearOpposites(unsigned char* nJoystickInputs)
{
...
static inline void System16MakeInputs()
{
	// Reset Inputs
...
static inline void OutrunMakeInputs()
{
	// Reset Inputs
	System16Input[0] = 0;
...
static inline void PdriftMakeInputs()
{
	// Reset Inputs
	System16Input[0] = 0;
...
static inline int System16SndGetBank(int Reg86)
{
	return (Reg86>>4)&7;
}

static inline int PdriftSndGetBank(int Reg86)
{
	return (Reg86>>3)&0x1f;
}

static inline void System16YM2151IRQHandler(int Irq)
{
	if (Irq) {
...
static inline void System16YM2203IRQHandler(int, int nStatus)
{
	if (nStatus & 1) {
		ZetSetIRQLine(0xFF, ZET_IRQSTATUS_ACK);
	} else {
...
static inline int System16SynchroniseStream(int nSoundRate)
{
	return (long long)ZetTotalCycles() * nSoundRate / 4000000;
}

static inline double System16GetTime()
{
	return (double)ZetTotalCycles() / 4000000;
}

static inline int System18SynchroniseStream(int nSoundRate)
{
	return (long long)ZetTotalCycles() * nSoundRate / 8000000;
}

static inline double System18GetTime()
{
...
static inline int segaic16_compare_timer_clock(int which)
{
...
static inline void update_compare(int which, int update_history)
{
