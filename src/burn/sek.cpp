...
static inline void CheckBreakpoint_R(unsigned int a, const unsigned int m)
{
	a &= m;
...
static inline void CheckBreakpoint_W(unsigned int a, const unsigned int m)
{
	a &= m;
...
#ifdef EMU_A68K
	if (bBurnUseASM68K && nCPUType == 0x68000) {
