...
extern unsigned int snesPal[0x20000];
/*SPC700*/
...
extern unsigned char *memlookup[2048];
extern unsigned char memread[2048],memwrite[2048];
extern unsigned char accessspeed[2048];
...
/*Video*/
extern int nmi,vbl,joyscan;
extern int nmienable;

extern int ppumask;

extern int yirq,xirq,irqenable,irq;
extern int lines;
