...
struct BurnDriver BurnDrvCadash = {
	...
	CadashInit, TaitoExit, CadashFrame, DrvDraw, DrvScan, NULL,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvEto = {
	...
	EtoInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, NULL,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvAsuka = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC,
	NULL, asukaRomInfo, asukaRomName, AsukaInputInfo, AsukaDIPInfo,
	AsukaInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, NULL,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvAsukaj = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_TAITO_MISC,
...
struct BurnDriver BurnDrvGalmedes = {
	...
	GalmedesInit, TaitoExit, EtoFrame, DrvDraw, DrvScan, NULL,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBonzeadv = {
	...
	BonzeInit, TaitoExit, BonzeFrame, DrvDraw, DrvScan, NULL,
	320, 224, 4, 3
};
