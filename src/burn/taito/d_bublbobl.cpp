...
static struct BurnRomInfo DlandRomDesc[] = {
	{ "dl_3.bin",      0x08000, 0x01eb3e4f, BRF_ESS | BRF_PRG }, //  0	Z80 #1 Program Code
	{ "dl_5.bin",      0x08000, 0x75740b61, BRF_ESS | BRF_PRG }, //	 1
	{ "dl_4.bin",      0x08000, 0xc6a3776f, BRF_ESS | BRF_PRG }, //	 2

	{ "dl_1.bin",      0x08000, 0xae11a07b, BRF_ESS | BRF_PRG }, //  3	Z80 #2 Program

	{ "dl_2.bin",      0x08000, 0x4f9a26e8, BRF_ESS | BRF_PRG }, //  4	Z80 #3 Program

	{ "dl_6.bin",      0x10000, 0x6352d3fa, BRF_GRA },	     //  5	Tiles
	{ "dl_7.bin",      0x10000, 0x37a38b69, BRF_GRA },	     //  6
	{ "dl_8.bin",      0x10000, 0x509ee5b1, BRF_GRA },	     //  7
	{ "dl_9.bin",      0x10000, 0xae8514d7, BRF_GRA },	     //  8
	{ "dl_10.bin",     0x10000, 0x6d406fb7, BRF_GRA },	     //  9
	{ "dl_11.bin",     0x10000, 0xbdf9c0ab, BRF_GRA },	     //  10
...
static inline int DrvYM3526SynchroniseStream(int nSoundRate)
{
...
struct BurnDriver BurnDrvBub68705 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_TAITO_MISC,
...
struct BurnDriver BurnDrvDland = {
	"dland", "bublbobl", NULL, "1986",
	"Dream Land / Super Dream Land (bootleg of Bubble Bobble)\0", NULL, "bootleg", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_TAITO_MISC,
	NULL, DlandRomInfo, DlandRomName, BublboblInputInfo, BublboblDIPInfo,
	BoblboblInit, DrvExit, DrvFrame, NULL, DrvScan,
	NULL, 256, 224, 4, 3
};
