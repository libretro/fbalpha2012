...
struct BurnDriver BurnDrvOpwolf = {
	...
	"Operation Wolf (World, set 1)\0", "Imperfect Sound", "Taito Corporation Japan", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_TAITO_MISC,
...
struct BurnDriver BurnDrvOpwolfa = {
	...
	"Operation Wolf (World, set 2)\0", "Imperfect Sound", "Taito Corporation Japan", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC,
...
struct BurnDriver BurnDrvOpwolfj = {
	...
	"Operation Wolf (Japan)\0", "Imperfect Sound", "Taito Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC,
...
struct BurnDriver BurnDrvOpwolfu = {
	...
	"Operation Wolf (US)\0", "Imperfect Sound", "Taito America Corporation", "Taito Misc",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TAITO_MISC,
	NULL, OpwolfuRomInfo, OpwolfuRomName, OpwolfInputInfo, OpwolfuDIPInfo,
	OpwolfInit, TaitoMiscExit, TaitoMiscFrame, NULL, TaitoMiscScan,
...
struct BurnDriver BurnDrvOpwolfb = {
	...
	"Operation Bear\0", "Imperfect Sound", "[Taito] (Bear Corporation Korea bootleg)", "Taito Misc",
	NULL, NULL, NULL, NULL,
