...
static struct BurnDIPInfo batridjRegionDIPList[] = {
	// Defaults
...
STDDIPINFOEXT(batridj, batridjRegion, batrider);
...
struct BurnDriver BurnDrvBatrid = {
	...
	"Armed Police Batrider (Europe) (Fri Feb 13 1998)\0", "B Version", "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvBatridu = {
	...
	"Armed Police Batrider (U.S.A.) (Fri Feb 13 1998)\0", "B Version", "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvBatridc = {
	...
	"Armed Police Batrider (China) (Fri Feb 13 1998)\0", "B Version", "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
...
struct BurnDriver BurnDrvBatridj = {
	...
	"Armed Police Batrider - B Version (Japan) (Fri Feb 13 1998)\0", "B Version", "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, batridjRomInfo, batridjRomName, batriderInputInfo, batridjDIPInfo,
	drvInit, drvExit, drvFrame, drvDraw, drvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBatridk = {
	...
	"Armed Police Batrider (Korea) (Fri Feb 13 1998)\0", "B Version", "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
...
struct BurnDriver BurnDrvBatridja = {
	...
	"Armed Police Batrider (Japan) (Mon Dec 22 1997)\0", "A Version", "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, batridjaRomInfo, batridjaRomName, batriderInputInfo, batridjDIPInfo,
	drvInit, drvExit, drvFrame, drvDraw, drvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
