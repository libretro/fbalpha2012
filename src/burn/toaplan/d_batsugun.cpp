...
//	{ "tp030.mcu",	  0x008000, 0x00000000, BRF_NODUMP },   	 //  7 Sound CPU
...
static struct BurnDIPInfo batsugunDIPList[] = {
	...
	{0x14,	0xFF, 0xFF,	0x09, NULL},

	// DIP 1
	{0,		0xFE, 0,	2,	  NULL},
	{0x12,	0x01, 0x01,	0x00, "Normal continue"},
	{0x12,	0x01, 0x01,	0x01, "Discount continue"},
	{0,		0xFE, 0,	2,	  NULL},
	{0x12,	0x01, 0x02,	0x00, "Normal screen"},
	{0x12,	0x01, 0x02,	0x02, "Invert screen"},
	{0,		0xFE, 0,	2,	  NULL},
	{0x12,	0x01, 0x04,	0x00, "Normal mode"},
	{0x12,	0x01, 0x04,	0x04, "Test mode"},
	...
	{0,		0xFE, 0,	4,	  "Coin A"},
	{0x12,	0x82, 0x30,	0x00, "1 coin 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x82, 0x30,	0x10, "1 coin 2 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x82, 0x30,	0x20, "2 coins 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x82, 0x30,	0x30, "2 coins 3 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0,		0xFE, 0,	4,	  "Coin B"},
	{0x12,	0x82, 0xC0,	0x00, "1 coin 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x82, 0xC0,	0x40, "1 coin 2 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x82, 0xC0,	0x80, "2 coins 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x82, 0xC0,	0xC0, "2 coins 3 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},

	// European coin settings
	{0,		0xFE, 0,	4,	  "Coin A"},
	{0x12,	0x02, 0x30,	0x00, "1 coin 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x02, 0x30,	0x10, "2 coins 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x02, 0x30,	0x20, "3 coins 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x02, 0x30,	0x30, "4 coins 1 play"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0,		0xFE, 0,	4,	  "Coin B"},
	{0x12,	0x02, 0xC0,	0x00, "1 coin 2 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x02, 0xC0,	0x40, "1 coin 3 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x02, 0xC0,	0x80, "1 coin 4 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},
	{0x12,	0x02, 0xC0,	0xC0, "1 coin 6 plays"},
	{0x14,	0x00, 0x0E, 0x08, NULL},

	// DIP 2
	{0,		0xFE, 0,	4,	  "Game difficulty"},
	{0x13,	0x01, 0x03,	0x00, "B (normal)"},
	{0x13,	0x01, 0x03,	0x01, "A (easy)"},
	{0x13,	0x01, 0x03,	0x02, "C (hard)"},
	{0x13,	0x01, 0x03,	0x03, "D (very hard)"},
	{0,		0xFE, 0,	4,	  "Extend"},
	{0x13,	0x01, 0x0C,	0x00, "1,000,000pts only"},
	{0x13,	0x01, 0x0C,	0x04, "500,000 600,000 every"},
	{0x13,	0x01, 0x0C,	0x08, "1,500,000pts only"},
	{0x13,	0x01, 0x0C,	0x0C, "No extend"},
	{0,		0xFE, 0,	4,	  "Hero counts"},
	{0x13,	0x01, 0x30,	0x00, "3"},
	{0x13,	0x01, 0x30,	0x10, "5"},
	{0x13,	0x01, 0x30,	0x20, "2"},
	{0x13,	0x01, 0x30,	0x30, "1"},
	{0,		0xFE, 0,	2,	  NULL},
	{0x13,	0x01, 0x40,	0x00, "Normal game"},
	{0x13,	0x01, 0x40,	0x40, "Debug mode"},
	{0,		0xFE, 0,	2,	  "Continue"},
	...
	// Region
	{0,		0xFE, 0,	14,	  "Region"},
	{0x14,	0x01, 0x0F,	0x00, "Korea (Unite Trading license)"},
	{0x14,	0x01, 0x0F,	0x01, "Korea"},
	{0x14,	0x01, 0x0F,	0x02, "Hong Kong (Taito license)"},
	{0x14,	0x01, 0x0F,	0x03, "Hong Kong"},
	{0x14,	0x01, 0x0F,	0x04, "Taiwan (Taito license)"},
	{0x14,	0x01, 0x0F,	0x05, "Taiwan"},
	{0x14,	0x01, 0x0F,	0x06, "South East Asia (Taito license)"},
	{0x14,	0x01, 0x0F,	0x07, "South East Asia"},
	{0x14,	0x01, 0x0F,	0x08, "Europe (Taito license)"},
	{0x14,	0x01, 0x0F,	0x09, "Europe"},
	{0x14,	0x01, 0x0F,	0x0A, "U.S.A (Taito license)"},
	{0x14,	0x01, 0x0F,	0x0B, "U.S.A"},
	{0x14,	0x01, 0x0F,	0x0C, "Japan (Taito license)"},
	{0x14,	0x01, 0x0F,	0x0E, "Japan"},
	{0x14,	0x01, 0x0F,	0x0D, "Japan (Taito license)"},
	{0x14,	0x01, 0x0F,	0x0F, "Japan"},
};
...
static int MemIndex()
{
	...
	Rom01		= Next; Next += 0x080000;		// CPU 68K code
...
struct BurnDriver BurnDrvBatsugunA = {
	"batsuguna", "batsugun", NULL, "1993",
	"Batsugun (set 2)\0", "No sound (sound MCU not dumped)", "Toaplan", "Dual Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvBatsugunSP = {
	...
	"Batsugun (Special Ver.)\0", "No sound (sound MCU not dumped)", "Toaplan", "Dual Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_68K_Zx80,
