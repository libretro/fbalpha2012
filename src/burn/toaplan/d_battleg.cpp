...
static struct BurnDIPInfo battlegDIPList[] = {
	...
	{0x15,	0x01, 0x02,	0x00, "1 credit"},
	{0x15,	0x01, 0x02,	0x02, "2 credits"},
	{0,		0xFE, 0,	8,	  "Coin 1"},
	...
	{0x15,	0x02, 0x20,	0x00, "Special"},
	{0x15,	0x00, 0x1C, 0x1C, NULL},
	{0x15,	0x02, 0x20,	0x20, "Normal"},
	{0x15,	0x00, 0x1C, 0x1C, NULL},
	{0,		0xFE, 0,	2,	  "Effect"},
	...
	{0x16,	0x01, 0x70, 0x00, "3"},
	{0x16,	0x01, 0x70, 0x10, "4"},
	{0x16,	0x01, 0x70, 0x20, "2"},
	{0x16,	0x01, 0x70, 0x30, "1"},
	{0x16,	0x01, 0x70, 0x40, "5"},
	{0x16,	0x01, 0x70, 0x50, "6"},
	{0x16,	0x01, 0x70, 0x60, "Multiple"},
	{0x16,	0x01, 0x70, 0x70, "Invincible"},
    // Nippon and U.S.A. regions
	{0,		0xFE, 0,	2,	  "Extra player"},
	{0x16,	0x02, 0x80, 0x00, "1000000 each"},
	{0x17,	0x00, 0x01, 0x00, NULL},
	{0x16,	0x02, 0x80, 0x80, "1000000 2000000"},
	{0x17,	0x00, 0x01, 0x00, NULL},

    // Europe/Denmark and Asia regions
	{0,		0xFE, 0,	2,	  "Extra player"},
	{0x16,	0x02, 0x80, 0x80, "2000000 each"},
	{0x17,	0x00, 0x01, 0x01, NULL},
	{0x16,	0x02, 0x80, 0x00, "No extra"},
	{0x17,	0x00, 0x01, 0x01, NULL},
...
static struct BurnDIPInfo battlegRegionDIPList[] = {
	// Region
	{0x17,	0xFF, 0x0F,	0x03, NULL},
	{0,		0xFE, 0,	2,	  "Region"},
	{0x17,	0x01, 0x03, 0x01, "Denmark"},
	{0x17,	0x01, 0x03, 0x03, "China"},
	{0x17,	0x01, 0x03, 0x00, "Nippon [illegal setting]"},
	{0x17,	0x01, 0x03, 0x02, "U.S.A. [illegal setting]"},
};

static struct BurnDIPInfo battlegaRegionDIPList[] = {
	// DIP 3
	{0,		0xFE, 0,	2,	  "Stage edit"},
	{0x17,	0x01, 0x08, 0x00, "Disable"},
	{0x17,	0x01, 0x08, 0x08, "Enable"},

	// Region
	{0x17,	0xFF, 0x0F,	0x01, NULL},
	{0,		0xFE, 0,	4,	  "Region"},
	{0x17,	0x01, 0x03, 0x00, "Nippon"},
	{0x17,	0x01, 0x03, 0x01, "Europe"},
	{0x17,	0x01, 0x03, 0x02, "U.S.A."},
	{0x17,	0x01, 0x03, 0x03, "Asia"},
};
...
static struct BurnDIPInfo battlegbRegionDIPList[] = {
	...
	{0x17,	0xFF, 0x0F,	0x03, NULL},
	{0,		0xFE, 0,	2,	  "Region"},
	{0x17,	0x01, 0x03, 0x01, "Austria"},
	{0x17,	0x01, 0x03, 0x03, "Hongkong"},
	{0x17,	0x01, 0x03, 0x00, "Nippon [illegal setting]"},
	{0x17,	0x01, 0x03, 0x02, "U.S.A. [illegal setting]"},
};

static struct BurnDIPInfo battlegcRegionDIPList[] = {
	// DIP 3
	{0,		0xFE, 0,	2,	  "Stage edit"},
	{0x17,	0x01, 0x08, 0x00, "Disable"},
	{0x17,	0x01, 0x08, 0x08, "Enable"},
...
static struct BurnDIPInfo battlegdRegionDIPList[] = {
	// Region
	{0x17,	0xFF, 0x0F,	0x03, NULL},
	{0,		0xFE, 0,	2,	  "Region"},
	{0x17,	0x01, 0x03, 0x01, "Germany"},
	{0x17,	0x01, 0x03, 0x03, "Taiwan"},
	{0x17,	0x01, 0x03, 0x00, "Nippon [illegal setting]"},
	{0x17,	0x01, 0x03, 0x02, "U.S.A. [illegal setting]"},
};
...
STDDIPINFOEXT(battlegc, battleg, battlegcRegion)
STDDIPINFOEXT(battlegd, battleg, battlegdRegion)
...
static int MemIndex()
{
	...
	Rom01		= Next; Next += 0x100000;			// CPU 68K ROM
...
struct BurnDriver BurnDrvBgaregGA = {
	...
	NULL, bgareggaRomInfo, bgareggaRomName, battlegInputInfo, battlegaDIPInfo,
...
struct BurnDriver BurnDrvBgareggaHK = {
	...
	NULL, bgareggahkRomInfo, bgareggahkRomName, battlegInputInfo, battlegbDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBgareggaTW = {
	...
	"Battle Garegga (Germany / Taiwan) (Thu Feb 1 1996)\0", NULL, "Raizing / Eighting", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bgareggatwRomInfo, bgareggatwRomName, battlegInputInfo, battlegdDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBgareggaNV = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bgaregganvRomInfo, bgaregganvRomName, battlegInputInfo, battlegcDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBgareggat2 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bgareggat2RomInfo, bgareggat2RomName, battlegInputInfo, battlegaDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBgareggaCN = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bgareggacnRomInfo, bgareggacnRomName, battlegInputInfo, battlegDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
