...
static struct BurnDIPInfo bkraidjRegionDIPList[] = {
	// Defaults
...
STDDIPINFOEXT(bkraidj, bkraidjRegion, bbakraid)
STDDIPINFOEXT(bkraidu, bkraiduRegion, bbakraid)
...
struct BurnDriver BurnDrvBattleBkraiduj = {
	...
	"Battle Bakraid - Unlimited Version (Japan) (Tue Jun 8 1999)\0", "Unlimited version", "Eighting", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bkraidujRomInfo, bkraidujRomName, bbakraidInputInfo, bkraidjDIPInfo,
	bbakraidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBattleBkraidj = {
	...
	"Battle Bakraid (Japan) (Wed Apr 7 1999)\0", "Unlimited version", "Eighting", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, bkraidjRomInfo, bkraidjRomName, bbakraidInputInfo, bkraidjDIPInfo,
	bbakraidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	240, 320, 3, 4
};
