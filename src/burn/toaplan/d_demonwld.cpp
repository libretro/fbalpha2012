...
struct BurnDriver BurnDrvDemonwld = {
	...
	NULL, NULL, NULL, NULL,
	0, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, demonwldRomInfo, demonwldRomName, DemonwldInputInfo, DemonwldDIPInfo,
	demonwldInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDemonwld1 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_CLONE, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, demonwld1RomInfo, demonwld1RomName, DemonwldInputInfo, Demonwl1DIPInfo,
	demonwld1Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDemonwld3 = {
	...
	demonwld3Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	320, 240, 4, 3
};
