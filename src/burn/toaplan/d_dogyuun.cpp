...
//	{ "tp022.mcu",	  0x008000, 0x00000000, BRF_NODUMP },	     //  5 Sound CPU
...
static struct BurnDIPInfo dogyuundefaultDIPList[] = {
	// Defaults
...
static struct BurnDIPInfo dogyuunkdefaultDIPList[] = {
	// Defaults
	{0x14,	0xFF, 0xFF,	0x00, NULL},
	{0x15,	0xFF, 0xFF,	0x00, NULL},
...
static struct BurnDIPInfo dogyuungameDIPList[] = {
	// DIP 1
	{0,		0xFE, 0,	2,	  NULL},
	...
	{0x16,	0x00, 0x0F, 0x03, NULL},
	{0x14,	0x02, 0xC0,	0x80, "1 coin 4 plays"},
	{0x16,	0x00, 0x0F, 0x03, NULL},
	...
	{0x16,	0x01, 0x0F,	0x02, "U.S.A. (Atari Games license)"},
	{0x16,	0x01, 0x0F,	0x03, "Europe"},
	{0x16,	0x01, 0x0F,	0x04, "Hong Kong (Charterfield license)"},
	{0x16,	0x01, 0x0F,	0x05, "Korea (Unite Trading license)"},
	{0x16,	0x01, 0x0F,	0x06, "Taiwan"},
	{0x16,	0x01, 0x0F,	0x08, "South East Asia (Charterfield license)"},
	{0x16,	0x01, 0x0F,	0x07, "U.S.A."},
	{0x16,	0x01, 0x0F,	0x09, "Hong Kong (Charterfield license)"},
	{0x16,	0x01, 0x0F,	0x0A, "Korea (Unite Trading license)"},
	{0x16,	0x01, 0x0F,	0x0B, "Taiwan"},
	{0x16,	0x01, 0x0F,	0x0C, "U.S.A. (Atari Games license)"},
	{0x16,	0x01, 0x0F,	0x0D, "South East Asia (Charterfield license)"},
	{0x16,	0x01, 0x0F,	0x0E, "Europe"},
	{0x16,	0x01, 0x0F,	0x0F, "Taiwan"},
};

STDDIPINFOEXT(dogyuun, dogyuundefault, dogyuungame);
STDDIPINFOEXT(dogyuunk, dogyuunkdefault, dogyuungame);
...
struct BurnDriver BurnDrvDogyuunk = {
	...
	L"Dogyuun\0Dogyuun \u30C9\u30AD\u30E5\u30FC\u30F3\uFF01\uFF01 (Licensed to Unite Trading For Korea)\0", NULL, NULL, NULL,
