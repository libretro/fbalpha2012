...
static struct BurnRomInfo hellfireRomDesc[] = {
	...
	{ "13.3w",        0x000020, 0xbc88cced, BRF_SND },			 // 11 N82S123AN bprom - Sprite attribute PROM
	{ "12.6b",        0x000020, 0xa1e17492, BRF_SND },			 // 12 N82S123AN bprom - ???
};
...
static struct BurnDIPInfo hellfireDIPList[] = {
	...
	{0,		0xFE, 0,	4,	  "Extend"},
	{0x13,	0x01, 0x0C,	0x00, "70000, 200000"},
	{0x13,	0x01, 0x0C,	0x04, "100000, 250000"},
	...
	{0x14,	0x01, 0x03,	0x01, "U.S.A."},
	{0x14,	0x01, 0x03,	0x02, "Europe"},
	{0x14,	0x01, 0x03,	0x03, "Europe"},
};
...
static struct BurnDIPInfo hellfire1DIPList[] = {
	...
	// DIP 1
	{0,		0xFE, 0,	2,	  NULL},
	{0x12,	0x01, 0x01,	0x01, "Up-right type"},
	{0x12,	0x01, 0x01,	0x00, "Table type"},
	{0,		0xFE, 0,	2,	  NULL},
	{0x12,	0x01, 0x02,	0x00, "Normal screen"},
	{0x12,	0x01, 0x02,	0x02, "Invert screen"},
	{0,		0xFE, 0,	2,	  NULL},
	{0x12,	0x01, 0x04,	0x00, "Normal game"},
	{0x12,	0x01, 0x04,	0x04, "Screen test mode"},
	{0,		0xFE, 0,	2,	  "Advertise sound"},
	{0x12,	0x01, 0x08,	0x08, "Off"},
	{0x12,	0x01, 0x08,	0x00, "On"},
...
static struct BurnDIPInfo hellfire2DIPList[] = {
	// Defaults
	{0x12,	0xFF, 0xFF,	0x00, NULL},
	{0x13,	0xFF, 0xFF,	0x00, NULL},
	{0x14,	0xFF, 0xFF,	0x02, NULL},
...
static int MemIndex()
{
	...
	Rom01		= Next; Next += 0x040000;		// CPU 68K code
	...
	RamPal		= Next; Next += 0x000800;		// palette
	RamPal2		= Next; Next += 0x000800;		// palette
...
struct BurnDriver BurnDrvHellfire1 = {
	...
	NULL, hellfire1RomInfo, hellfire1RomName, hellfireInputInfo, hellfire1DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvHellfire2 = {
	"hellfire2", "hellfire", NULL, "1989",
	"Hellfire (2P ver., first edition)\0", NULL, "Toaplan (Taito License)", "Toaplan BCU-2 / FCU-2 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TOAPLAN_RAIZING,
	NULL, hellfire2RomInfo, hellfire2RomName, hellfireInputInfo, hellfire2DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &ToaRecalcPalette,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvHellfire3 = {
