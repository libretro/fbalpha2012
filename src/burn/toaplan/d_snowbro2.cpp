...
static struct BurnDIPInfo snowbro2DIPList[] = {
	...
	{0x22,	0xFF, 0xFF,	0x08, NULL},

	// DIP 1
	{0,		0xFE, 0,	2,	  NULL},
	{0x20, 0x01, 0x01, 0x00, "Normal continue"},
	{0x20, 0x01, 0x01, 0x01, "Continue discount"},

	{0,		0xFE, 0,	2,	  NULL},
	{0x20, 0x01, 0x02, 0x00, "Normal screen"},
	{0x20, 0x01, 0x02, 0x02, "Invert screen"},

	{0,		0xFE, 0,	2,	  NULL},
	{0x20, 0x01, 0x04, 0x00, "Normal mode"},
	{0x20, 0x01, 0x04, 0x04, "Test mode"},
	...
	{0,		0xFE, 0,	4,	  "Coin A"},
	{0x20,	0x82, 0x30,	0x00, "1 coin 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x82, 0x30,	0x10, "1 coin 2 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x82, 0x30,	0x20, "2 coins 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x82, 0x30,	0x30, "2 coins 3 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0,		0xFE, 0,	4,	  "Coin B"},
	{0x20,	0x82, 0xC0,	0x00, "1 coin 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x82, 0xC0,	0x40, "1 coin 2 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x82, 0xC0,	0x80, "2 coins 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x82, 0xC0,	0xC0, "2 coins 3 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},

	// European coin settings
	{0,		0xFE, 0,	4,	  "Coin A"},
	{0x20,	0x02, 0x30,	0x00, "1 coin 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x02, 0x30,	0x10, "2 coins 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x02, 0x30,	0x20, "3 coins 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x02, 0x30,	0x30, "4 coins 1 credit"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0,		0xFE, 0,	4,	  "Coin B"},
	{0x20,	0x02, 0xC0,	0x00, "1 coin 2 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x02, 0xC0,	0x40, "1 coin 3 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x02, 0xC0,	0x80, "1 coin 4 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	{0x20,	0x02, 0xC0,	0xC0, "1 coin 6 credits"},
	{0x22,	0x00, 0x1C, 0x08, NULL},
	...
	{0,		0xFE, 0,	4,	  "Extend player"},
	{0x21, 0x01, 0x0C, 0x04, "100000 / 500000"},
	{0x21, 0x01, 0x0C, 0x00, "100000 only"},
	{0x21, 0x01, 0x0C, 0x08, "200000 only"},
	{0x21, 0x01, 0x0C, 0x0C, "No extend"},

	{0,		0xFE, 0,	4,	  "Player count"},
	{0x21, 0x01, 0x30, 0x30, "1 life"},
	{0x21, 0x01, 0x30, 0x20, "2 lives"},
	{0x21, 0x01, 0x30, 0x00, "3 lives"},
	{0x21, 0x01, 0x30, 0x10, "4 lives"},

	{0,		0xFE, 0,	2,	  NULL},
	{0x21, 0x01, 0x40, 0x00, "Normal game"},
...
static int DrvFrame()
{
	...
	DrvClearOpposites(&DrvInput[6]);
	DrvClearOpposites(&DrvInput[7]);
...
struct BurnDriver BurnDrvSnowbro2 = {
	...
	L"\u304A\u3066\u3093\u304D\u30D1\u30E9\u30C0\u30A4\u30B9\0\u96EA\u4EBA\u5144\u5F1F\uFF12\0\uB208\uC0AC\uB78C\uD615\uC81C\uFF12\0Snow Bros. 2 - With New Elves\0", NULL, NULL, NULL,
