...
static struct BurnRomInfo truxtonRomDesc[] = {
	...
	{ "b65_12.bpr",   0x000020, 0xbc88cced, BRF_OPT },			 // 11 Nibble bPROMs
	{ "b65_13.bpr",   0x000020, 0xa1e17492, BRF_OPT },			 // 12
};
...
static struct BurnDIPInfo truxtonDIPList[] = {
	...
	{0x13,	0x01, 0x0C,	0x04, "50000, 150000"},
	...
	{0x14,	0x01, 0x07,	0x01, "U.S.A. (Romstar)"},
	{0x14,	0x01, 0x07,	0x04, "U.S.A. (Taito America)"},
	{0x14,	0x01, 0x07,	0x02, "Europe (Taito corp.)"},
	{0x14,	0x01, 0x07,	0x06, "Europe (Taito America)"},
	{0x14,	0x01, 0x07,	0x03, "Europe (Taito corp.)"},
	{0x14,	0x01, 0x07,	0x07, "Europe (Taito America)"},
	{0x14,	0x01, 0x07,	0x05, "U.S.A. (Taito America)"},
};
