...
//	{ "tp027.mcu",	  0x008000, 0x00000000, BRF_NODUMP }, 		 //  3 Sound CPU
};
...
static struct BurnDIPInfo vfiveDIPList[] = {
	...
	{0,		0xFE, 0,	4,	  "Extend"},
	{0x13,	0x01, 0x0C,	0x00, "300,000pts 800,000pts"},
	{0x13,	0x01, 0x0C,	0x04, "300,000 800,000 every"},
	{0x13,	0x01, 0x0C,	0x08, "200,000pts only"},
...
static struct BurnDIPInfo grindstmRegionDIPList[] = {
	...
	{0x14,	0x01, 0x0F, 0x02, "Hong Kong (Charterfield license)"},
	{0x14,	0x01, 0x0F, 0x03, "Hong Kong"},
	{0x14,	0x01, 0x0F, 0x04, "Taiwan (Anamoto International license)"},
	{0x14,	0x01, 0x0F, 0x05, "Taiwan"},
	{0x14,	0x01, 0x0F, 0x06, "South East Asia (Charterfield license)"},
	{0x14,	0x01, 0x0F, 0x07, "South East Asia"},
	{0x14,	0x01, 0x0F, 0x08, "Europe"},
	{0x14,	0x01, 0x0F, 0x0A, "U.S.A. (American Sammy license)"},
	{0x14,	0x01, 0x0F, 0x0B, "U.S.A."},
	{0x14,	0x01, 0x0F, 0x09, "Europe"},
	{0x14,	0x01, 0x0F, 0x0C, "U.S.A. (American Sammy license)"},
	{0x14,	0x01, 0x0F, 0x0D, "U.S.A."},
	{0x14,	0x01, 0x0F, 0x0E, "Korea"},
	{0x14,	0x01, 0x0F, 0x0F, "Korea"},
};
...
static int MemIndex()
{
	...
	Rom01		= Next; Next += 0x080000;		// CPU 68K ROM
...
struct BurnDriver BurnDrvVFive = {
	...
	L"\u30F4\u30A3 \u30D5\u30A1\u30A4\u30F4 (Japan)\0V-Five\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvGrindStormerA = {
	...
	"Grind Stormer (older set)\0", "Alternate version, no sound (sound MCU not dumped)", "Toaplan", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_68K_Zx80,
