...
static inline void ToaGP9001SetRAMPointer(unsigned int wordValue, const int nController = 0)
{
...
static inline void ToaGP9001WriteRAM(const unsigned short wordValue, const int nController)
{
	extern unsigned char* GP9001Pointer[2];

	*((unsigned short*)(GP9001Pointer[nController])) = swapWord(wordValue);
	GP9001Pointer[nController] += 2;
}

static inline unsigned short ToaGP9001ReadRAM_Hi(const int nController)
{
	extern unsigned char* GP9001Pointer[2];

	return swapWord(*((unsigned short*)(GP9001Pointer[nController] )));
}

static inline unsigned short ToaGP9001ReadRAM_Lo(const int nController)
{
	extern unsigned char* GP9001Pointer[2];

	return swapWord(*((unsigned short*)(GP9001Pointer[nController] + 2)));
}

static inline void ToaGP9001SelectRegister(const unsigned short wordValue, const int nController = 0)
{
...
static inline void ToaGP9001WriteRegister(const unsigned short wordValue, const int nController = 0)
{
	extern int GP9001Regnum[2];
...
static inline unsigned short ToaVBlankRegister()
{
...
static inline unsigned short ToaScanlineRegister()
{
