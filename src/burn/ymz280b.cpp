...
static inline void UpdateIRQStatus()
{
	nYMZ280BIRQStatus = 0;
...
static inline void ComputeVolume(sYMZ280BChannelInfo* channel)
{
	if (channel->nPan == 8) {
...
static inline void RampChannel()
{
#if 1
...
static inline void DecodeOneSample()
{
...
static inline void ComputeOutput_Linear()
{
...
static inline void ComputeOutput_Cubic()
{
...
static inline void RenderADPCM_Linear()
{
	while (nCount--) {
...
static inline void RenderADPCMLoop_Linear()
{
	while (nCount--) {
		if (channelInfo->nFractionalPosition >= 0x01000000) {
...
static inline void RenderADPCM_Cubic()
{
	while (nCount--) {
		while (channelInfo->nFractionalPosition >= 0x01000000) {
...
static inline void RenderADPCMLoop_Cubic()
{
	while (nCount--) {
