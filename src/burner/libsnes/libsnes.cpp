...
static const keymap bindmap[] = {
   { SNES_DEVICE_ID_JOYPAD_A, P1_FIRE2, P2_FIRE5 },
   { SNES_DEVICE_ID_JOYPAD_B, P1_FIRE1, P2_FIRE4 },
   { SNES_DEVICE_ID_JOYPAD_Y, P1_FIRE4, P2_FIRE2 },
   { SNES_DEVICE_ID_JOYPAD_X, P1_FIRE5, P2_FIRE1 },
   { SNES_DEVICE_ID_JOYPAD_R, P1_FIRE3, P2_FIRE6 },
   { SNES_DEVICE_ID_JOYPAD_L, P1_FIRE6, P2_FIRE3 },
