...
#define CTRL_LSTICK_LEFT_PLUS_DPAD_MASK		0x1000000001000LLU
#define CTRL_LSTICK_RIGHT_PLUS_DPAD_MASK	0x2000000010000LLU
#define CTRL_LSTICK_UP_PLUS_DPAD_MASK		0x4000000100000LLU
#define CTRL_LSTICK_DOWN_PLUS_DPAD_MASK		0x4000001000000LLU
