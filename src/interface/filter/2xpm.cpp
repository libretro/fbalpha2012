...
static inline void _2xpm_hq_1516(unsigned char *SrcPtr, unsigned char *DstPtr, unsigned int SrcPitch, unsigned int DstPitch, unsigned int SrcW, unsigned int SrcH)
{
	unsigned long x, y;
	unsigned char * __restrict src, * __restrict dest;
...
void _2xpm_hq15(unsigned char *SrcPtr, unsigned int SrcPitch, unsigned char * /* deltaPtr */, unsigned char *DstPtr, unsigned int DstPitch, int SrcW, int SrcH)
{
...
void _2xpm_hq16(unsigned char *SrcPtr, unsigned int SrcPitch, unsigned char * /* deltaPtr */, unsigned char *DstPtr, unsigned int DstPitch, int SrcW, int SrcH)
{
