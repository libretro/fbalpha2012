...
static inline void hq2x_16_def(unsigned short* dst0, unsigned short* dst1, const unsigned short* src0, const unsigned short* src1, const unsigned short* src2, unsigned count)
{
  unsigned i;
...
static inline void hq2x_32_def(unsigned int* dst0, unsigned int* dst1, const unsigned int* src0, const unsigned int* src1, const unsigned int* src2, unsigned count)
{
  unsigned i;
...
static inline void hq2xS_16_def(unsigned short* dst0, unsigned short* dst1, const unsigned short* src0, const unsigned short* src1, const unsigned short* src2, unsigned count)
{
  unsigned i;
...
static inline void hq2xS_32_def(unsigned int* dst0, unsigned int* dst1, const unsigned int* src0, const unsigned int* src1, const unsigned int* src2, unsigned count)
{
  unsigned i;
...
void hq2x32(unsigned char *srcPtr, unsigned int srcPitch, unsigned char * /* deltaPtr */,
            unsigned char *dstPtr, unsigned int dstPitch, int width, int height)
{
...
void hq2xS(unsigned char *srcPtr, unsigned int srcPitch, unsigned char * /* deltaPtr */,
          unsigned char *dstPtr, unsigned int dstPitch, int width, int height)
{
  unsigned short *dst0 = (unsigned short *)dstPtr;
  unsigned short *dst1 = dst0 + (dstPitch >> 1);
...
void hq2xS32(unsigned char *srcPtr, unsigned int srcPitch, unsigned char * /* deltaPtr */,
            unsigned char *dstPtr, unsigned int dstPitch, int width, int height)
{
  unsigned int *dst0 = (unsigned int *)dstPtr;
  unsigned int *dst1 = dst0 + (dstPitch >> 2);
