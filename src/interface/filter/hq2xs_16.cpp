...
void RenderHQ2XS(unsigned char *src, unsigned int srcpitch, unsigned char *, unsigned char *dst, unsigned int dstpitch, int nWidth, int nHeight)
{
	if (!initluts) {
		InitLUTs();
	}
...
void RenderHQ2XBold(unsigned char *src, unsigned int srcpitch, unsigned char *, unsigned char *dst, unsigned int dstpitch, int nWidth, int nHeight)
{
	if (!initluts) {
		InitLUTs();
	}
...
void RenderHQ3XS(unsigned char *src, unsigned int srcpitch, unsigned char *, unsigned char *dst, unsigned int dstpitch, int nWidth, int nHeight)
{
	if (!initluts) {
		InitLUTs();
	}
...
void RenderHQ3XBold(unsigned char *src, unsigned int srcpitch, unsigned char *, unsigned char *dst, unsigned int dstpitch, int nWidth, int nHeight)
{
	if (!initluts) {
		InitLUTs();
	}
