...
public:
	...
	*/
	...
	bool SaveFile( TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING ) const;
	/// Load a file using the given filename. Returns true if successful.
	bool LoadFile( const char * filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given filename. Returns true if successful.
	bool SaveFile( const char * filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING ) const;
	...
	*/
	...
	bool SaveFile( FILE*, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING ) const;
...
//		return ( f.buffer && LoadFile( f.buffer, encoding ));
	...
	bool SaveFile( const std::string& filename, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING ) const		///< STL std::string version.
	{
//		StringToBuffer f( filename );
