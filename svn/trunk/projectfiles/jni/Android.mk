...
LOCAL_C_INCLUDES = $(LOCAL_PATH)/$(FBA_BURNER_DIR)/win32 \
	$(LOCAL_PATH)/$(LIBRETRO_DIR) \
	$(LOCAL_PATH)/$(LIBRETRO_DIR)/tchar \
	$(LOCAL_PATH)/$(FBA_BURN_DIR) \
	$(LOCAL_PATH)/$(MAIN_FBA_DIR)/cpu \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/snd \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/devices \
	$(LOCAL_PATH)/$(FBA_INTERFACE_DIR) \
	$(LOCAL_PATH)/$(FBA_INTERFACE_DIR)/input \
	$(LOCAL_PATH)/$(FBA_INTERFACE_DIR)/cd \
	$(LOCAL_PATH)/$(FBA_BURNER_DIR) \
	$(LOCAL_PATH)/$(FBA_CPU_DIR) \
	$(LOCAL_PATH)/$(FBA_CPU_DIR)/i8039 \
	$(LOCAL_PATH)/$(FBA_LIB_DIR)/zlib \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/capcom \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/dataeast \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/cave \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/neogeo \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/psikyo \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/sega \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/toaplan \
	$(LOCAL_PATH)/$(FBA_BURN_DIR)/drv/taito \
	$(LOCAL_PATH)/$(FBA_GENERATED_DIR) \
	$(LOCAL_PATH)/$(FBA_LIB_DIR)
